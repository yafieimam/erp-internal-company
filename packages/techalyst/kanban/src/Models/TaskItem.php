...
namespace Techalyst\Kanban\Models;
...
class TaskItem extends Model
{
    ...
    {
        return $this->belongsToMany('Techalyst\Kanban\Models\TaskBoard','kanban_task_board_item','itemId','boardId')->withPivot('active','entered_at','left_at','item_order','archived');
    }
