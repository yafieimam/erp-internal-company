...
class TaskBoard extends Model
{
    ...
    {
        return $this->belongsToMany('Techalyst\Kanban\Models\TaskItem','kanban_task_board_item','boardId','itemId')->withPivot('active','entered_at','left_at','item_order','archived');
    }
