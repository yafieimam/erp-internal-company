...
@section('title')
<title>TERIMA CEK / GIRO - PT. DWI SELO GIRI MAS</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Terima Cek / Giro</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/homepage') }}">Home</a></li>
            <li class="breadcrumb-item">Penagihan</li>
            <li class="breadcrumb-item">Terima Cek / Giro</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<script type="text/javascript">
  $(document).ready(function () {
    var table = $('#data_terima_table').DataTable({
         ...
         ajax: {
          url:'{{ url("penagihan/terima_cek_ondomohen/table") }}',
    ...
    function load_data_terima_detail(tanggal = '')
    {
      table = $('#detail_data_terima_table').DataTable({
        ...
        bInfo : false,
        ajax: {
          url:'{{ url("penagihan/terima_cek_ondomohen/detail/table") }}',
        ...
        {
          data:'check_diterima_cek_ondomohen',
          name:'check_diterima_cek_ondomohen',
          className:'dt-center',
          render: function ( data, type, row)
          {
            if(data){
    ...
    $('#btn-save-data').click( function() {
      ...
      $.ajax({
        ...
        type: "POST",
        url: '{{ url("penagihan/update/terima_cek_ondomohen") }}',
        dataSrc : 'data',
        dataType: 'JSON',
        data: data,
        async: 'false',
