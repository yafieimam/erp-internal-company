...
@section('nav')
            <div class="bahasa">
                <p>
                  <a href="{{ url('en/edit_password') }}"><span class="active">EN</span></a>
                  &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                  <a href="{{ url('id/edit_password') }}"><span class="">IN</span></a>
                </p>
            </div>
@endsection
          ...
          <div class="form-row">
            <div class="form-group" style="margin: auto;">
              ...
              <div class="form-input validate-input wow fadeInUp" data-validate = "Confirm New Password is required">
                <label for="confirm_pass" class="required">Confirm New Password</label>
                <input class="input-baru" type="password" name="confirm_pass" id="confirm_pass" placeholder="Confirm New Password" />
              </div>
              <input type="submit" value="Submit" class="submit" id="submit" name="submit" onclick="javascript: form.action='{{ url('/editPasswordEn') }}';" style="float: right; margin: 0;"/>
            </div>
          </div>
        </form>
      </div>
...
<script type="text/javascript">
    var baseurl = "{{ url('/en/edit_password') }}";
