...
<style type="text/css">
  ...
  input[type='date'] {min-height: 2em;} 
      ...
      <div class="card">
        <div class="card-header">
          <ul class="nav nav-tabs nav-tabs-lihat" id="custom-content-below-tab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#rencana_penagihan" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Rencana Jadwal</a>
            </li>
            <li class="nav-item">
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = $('#data_rencana_penagihan_table').DataTable({
      ...
      ajax: {
        url:'{{ url("penagihan/rencana_penagihan/collector/table") }}',
    ...
    function load_data_penagihan_final(from_date = '', to_date = '')
    {
      table = $('#data_penagihan_final_table').DataTable({
        ...
        lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
        ajax: {
          url:'{{ url("penagihan/penagihan_final/collector/table") }}',
          data:{from_date:from_date, to_date:to_date},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
    ...
    function load_data_sorting(tanggal = '')
    {
      table = $('#data_sorting_table').DataTable({
        ...
        columns: [
        {
          ...
          render: function ( data, type, row)
          {
            return '<input type="hidden" name="nosj[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.nosj).html() + '"><input type="hidden" name="jadwal[' + $('<div />').text(row.nosj).html() + ']"><input type="hidden" name="keterangan_jadwal[' + $('<div />').text(row.nosj).html() + ']">' + $('<div />').text(row.nosj).html();
          }
        },
        {
          data:'noinv',
        ...
        },
        {
          ...
          render: function ( data, type, row)
          {
            $('[name="jadwal_temp[' + $('<div />').text(row.nosj).html() + ']"]').change(function(){
              var date = $(this).val();
              $('[name="jadwal[' + $('<div />').text(row.nosj).html() + ']"]').val(date);
            });

            return '<input type="date" class="jadwal" name="jadwal_temp[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.tanggal_jadwal_penagihan).html() + '" style="width:100%;">';
          }
        },
        {
          data:'keterangan_jadwal_penagihan',
          ...
          render: function ( data, type, row)
          {
            $('[name="keterangan_jadwal_temp[' + $('<div />').text(row.nosj).html() + ']"]').bind('input propertychange', function() {
              var isi = this.value;
              $('[name="keterangan_jadwal[' + $('<div />').text(row.nosj).html() + ']"]').val(isi);
            });

            return '<textarea rows="2" class="keterangan_jadwal" name="keterangan_jadwal_temp[' + $('<div />').text(row.nosj).html() + ']" style="width:100%;">' + $('<div />').text(row.keterangan_jadwal_penagihan).html() + '</textarea>';
          }
        }
        ]
      });
    ...
    function load_data_edit(tanggal = '')
    {
      table = $('#data_edit_table').DataTable({
        ...
        columns: [
        {
          ...
          render: function ( data, type, row)
          {
            return '<input type="hidden" name="edit_nosj[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.nosj).html() + '"><input type="hidden" name="edit_jadwal[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.tanggal_jadwal_penagihan).html() + '"><input type="hidden" name="edit_keterangan_jadwal[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.keterangan_jadwal_penagihan).html() + '">' + $('<div />').text(row.nosj).html();
          }
        },
        {
          data:'noinv',
        ...
        },
        {
          ...
          render: function ( data, type, row)
          {
            $('[name="edit_jadwal_temp[' + $('<div />').text(row.nosj).html() + ']"]').change(function(){
              var date = $(this).val();
              $('[name="edit_jadwal[' + $('<div />').text(row.nosj).html() + ']"]').val(date);
            });

            return '<input type="date" class="edit_jadwal" name="edit_jadwal_temp[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.tanggal_jadwal_penagihan).html() + '" style="width:100%;">';
          }
        },
        {
          data:'keterangan_jadwal_penagihan',
          ...
          render: function ( data, type, row)
          {
            $('[name="edit_keterangan_jadwal_temp[' + $('<div />').text(row.nosj).html() + ']"]').bind('input propertychange', function() {
              var isi = this.value;
              $('[name="edit_keterangan_jadwal[' + $('<div />').text(row.nosj).html() + ']"]').val(isi);
            });

            return '<textarea rows="2" class="edit_keterangan_jadwal" name="edit_keterangan_jadwal_temp[' + $('<div />').text(row.nosj).html() + ']" style="width:100%;">' + $('<div />').text(row.keterangan_jadwal_penagihan).html() + '</textarea>';
          }
        }
        ]
      });
    ...
    function load_data_update(tanggal = '')
    {
      table = $('#data_update_table').DataTable({
        ...
        columns: [
        {
          ...
          render: function ( data, type, row)
          {
            return '<input type="hidden" name="nosj_update[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.nosj).html() + '"><input type="checkbox" name="dibayar[' + $('<div />').text(row.nosj).html() + ']" style="display:none;"><input type="hidden" name="tagih_cust[' + $('<div />').text(row.nosj).html() + ']"><input type="hidden" name="metode[' + $('<div />').text(row.nosj).html() + ']" value="1"><input type="hidden" name="nomor[' + $('<div />').text(row.nosj).html() + ']"><input type="hidden" name="nominal[' + $('<div />').text(row.nosj).html() + ']"><input type="hidden" name="keterangan_penagihan[' + $('<div />').text(row.nosj).html() + ']">' + $('<div />').text(row.nosj).html();
          }
        },
        {
          data:'noinv',
        ...
        },
        {
          ...
          render: function ( data, type, row)
          {
            $('[name="dibayar_temp[' + $('<div />').text(row.nosj).html() + ']"]').change(function(){
              if($(this).is(':checked')) {
                $('[name="tagih_cust_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", false);
                $('[name="keterangan_penagihan_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", false);
                $('[name="metode_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", false);
                $('[name="nominal_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", false);
                $('[name="nomor_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", false);
                $('[name="dibayar[' + $('<div />').text(row.nosj).html() + ']"]').prop("checked", true);
              }else{
                $('[name="tagih_cust_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", true);
                $('[name="keterangan_penagihan_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", true);
                $('[name="metode_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", true);
                $('[name="nominal_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", true);
                $('[name="nomor_temp[' + $('<div />').text(row.nosj).html() + ']"]').prop("disabled", true);
                $('[name="dibayar[' + $('<div />').text(row.nosj).html() + ']"]').prop("checked", false);
              }
            });

            if(data == 1){
              return '<input type="checkbox" class="dibayar" name="dibayar_temp[' + $('<div />').text(row.nosj).html() + ']" value="1" checked>';
            }else{
              return '<input type="checkbox" class="dibayar" name="dibayar_temp[' + $('<div />').text(row.nosj).html() + ']" value="1">';
            }
          }
        },
        {
          ...
          render: function ( data, type, row)
          {
            $('[name="tagih_cust_temp[' + $('<div />').text(row.nosj).html() + ']"]').change(function(){
              var date = $(this).val();
              $('[name="tagih_cust[' + $('<div />').text(row.nosj).html() + ']"]').val(date);
            });

            return '<input type="date" class="tagih_cust" name="tagih_cust_temp[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.tanggal_tagih_cust).html() + '" style="width:100%;" disabled>';
          }
        },
        {
          ...
          render: function ( data, type, row)
          {
            $('[name="metode_temp[' + $('<div />').text(row.nosj).html() + ']"]').change(function(){
              if ($(this).val() == 2 || $(this).val() == 3) {
                $('[name="nomor_temp[' + $('<div />').text(row.nosj).html() + ']"]').show();
                $('[name="nominal_temp[' + $('<div />').text(row.nosj).html() + ']"]').show();
                $('[name="metode[' + $('<div />').text(row.nosj).html() + ']"]').val($(this).val());
              }else if($(this).val() == 1){
                $('[name="nomor_temp[' + $('<div />').text(row.nosj).html() + ']"]').hide();
                $('[name="nominal_temp[' + $('<div />').text(row.nosj).html() + ']"]').show();
                $('[name="metode[' + $('<div />').text(row.nosj).html() + ']"]').val($(this).val());
              }else{
                $('[name="nomor_temp[' + $('<div />').text(row.nosj).html() + ']"]').hide();
                $('[name="nominal_temp[' + $('<div />').text(row.nosj).html() + ']"]').hide();
                $('[name="metode[' + $('<div />').text(row.nosj).html() + ']"]').val($(this).val());
              }
            });
            ...
            $('[name="dibayar_temp[' + $('<div />').text(row.nosj).html() + ']"]').change(function(){
              if ($(this).is(':checked')) {
                $('[name="nominal_temp[' + $('<div />').text(row.nosj).html() + ']"]').val($('<div />').text(row.tagihan).html());
                $('[name="nominal[' + $('<div />').text(row.nosj).html() + ']"]').val($('<div />').text(row.tagihan).html());
              }else{
                $('[name="nominal_temp[' + $('<div />').text(row.nosj).html() + ']"]').val('');
                $('[name="nominal[' + $('<div />').text(row.nosj).html() + ']"]').val('');
              }
            });

            $('[name="nomor_temp[' + $('<div />').text(row.nosj).html() + ']"]').bind('input propertychange', function() {
              var isi = this.value;
              $('[name="nomor[' + $('<div />').text(row.nosj).html() + ']"]').val(isi);
            });

            $('[name="nominal_temp[' + $('<div />').text(row.nosj).html() + ']"]').bind('input propertychange', function() {
              var isi = this.value;
              $('[name="nominal[' + $('<div />').text(row.nosj).html() + ']"]').val(isi);
            });

            return '<select class="metode" name="metode_temp[' + $('<div />').text(row.nosj).html() + ']" style="width:100%;" disabled>' +
            '<option value="1">Cash</option>'+
            '<option value="2">Giro</option>'+
            '<option value="3">Cek</option>'+
            '<option value="4">Transfer</option>'+
            '</select>'+
            '<input type="text" class="nomor" name="nomor_temp[' + $('<div />').text(row.nosj).html() + ']" style="width:100%; margin-top: 10px; display: none;" placeholder="Nomor">'+
            '<input type="text" class="nominal" name="nominal_temp[' + $('<div />').text(row.nosj).html() + ']" style="width:100%; margin-top: 10px;" placeholder="Nominal" disabled>';
          }
        },
        {
          data:'keterangan_penagihan',
          ...
          render: function ( data, type, row)
          {
            $('[name="keterangan_penagihan_temp[' + $('<div />').text(row.nosj).html() + ']"]').bind('input propertychange', function() {
              var isi = this.value;
              $('[name="keterangan_penagihan[' + $('<div />').text(row.nosj).html() + ']"]').val(isi);
            });

            return '<textarea rows="2" class="keterangan_penagihan" name="keterangan_penagihan_temp[' + $('<div />').text(row.nosj).html() + ']" style="width:100%;" disabled>' + $('<div />').text(row.keterangan_penagihan).html() + '</textarea>';
          }
        }
        ]
      });
    ...
    $('#data_sorting_table').on('change', 'tbody tr .jadwal', function () {
      if(table.responsive.hasHidden()) {
        var cust = table.row(this).data();
        $('[name="jadwal[' + cust.nosj + ']"]').val($(this).val());
      }
    });

    $('#data_sorting_table').on('keyup blur', 'tbody tr .keterangan_jadwal', function () {
      if(table.responsive.hasHidden()){
        var cust = table.row(this).data();
        $('[name="keterangan_jadwal[' + cust.nosj + ']"]').val($(this).val());
      }
    });

    $('#data_edit_table').on('change', 'tbody tr .edit_jadwal', function () {
      if(table.responsive.hasHidden()) {
        var cust = table.row(this).data();
        $('[name="edit_jadwal[' + cust.nosj + ']"]').val($(this).val());
      }
    });

    $('#data_edit_table').on('keyup blur', 'tbody tr .edit_keterangan_jadwal', function () {
      if(table.responsive.hasHidden()){
        var cust = table.row(this).data();
        $('[name="edit_keterangan_jadwal[' + cust.nosj + ']"]').val($(this).val());
      }
    });

    $('#data_update_table').on('change', 'tbody tr .dibayar', function () {
      if(table.responsive.hasHidden()){
        var cust = table.row(this).data();
        if($(this).is(':checked')) {
          $('[name="tagih_cust_temp[' + cust.nosj + ']"]').prop("disabled", false);
          $('[name="keterangan_penagihan_temp[' + cust.nosj + ']"]').prop("disabled", false);
          $('[name="metode_temp[' + cust.nosj + ']"]').prop("disabled", false);
          $('[name="nominal_temp[' + cust.nosj + ']"]').prop("disabled", false);
          $('[name="nomor_temp[' + cust.nosj + ']"]').prop("disabled", false);
          $('[name="dibayar[' + cust.nosj + ']"]').prop("checked", true);
          $('[name="nominal_temp[' + cust.nosj + ']"]').val(cust.tagihan);
          $('[name="nominal[' + cust.nosj + ']"]').val(cust.tagihan);
        }else{
          $('[name="tagih_cust_temp[' + cust.nosj + ']"]').prop("disabled", true);
          $('[name="keterangan_penagihan_temp[' + cust.nosj + ']"]').prop("disabled", true);
          $('[name="metode_temp[' + cust.nosj + ']"]').prop("disabled", true);
          $('[name="nominal_temp[' + cust.nosj + ']"]').prop("disabled", true);
          $('[name="nomor_temp[' + cust.nosj + ']"]').prop("disabled", true);
          $('[name="dibayar[' + cust.nosj + ']"]').prop("checked", false);
          $('[name="dibayar[' + cust.nosj + ']"]').prop("checked", false);
          $('[name="nominal_temp[' + cust.nosj + ']"]').val('');
          $('[name="nominal[' + cust.nosj + ']"]').val('');
        }
      }
    });

    $('#data_update_table').on('change', 'tbody tr .metode', function () {
      if(table.responsive.hasHidden()) {
        var cust = table.row(this).data();
        if ($(this).val() == 2 || $(this).val() == 3) {
          $('[name="nomor_temp[' + cust.nosj + ']"]').show();
          $('[name="nominal_temp[' + cust.nosj + ']"]').show();
          $('[name="metode[' + cust.nosj + ']"]').val($(this).val());
        }else if($(this).val() == 1){
          $('[name="nomor_temp[' + cust.nosj + ']"]').hide();
          $('[name="nominal_temp[' + cust.nosj + ']"]').show();
          $('[name="metode[' + cust.nosj + ']"]').val($(this).val());
        }else{
          $('[name="nomor_temp[' + cust.nosj + ']"]').hide();
          $('[name="nominal_temp[' + cust.nosj + ']"]').hide();
          $('[name="metode[' + cust.nosj + ']"]').val($(this).val());
        }
      }
    });

    $('#data_update_table').on('keyup blur', 'tbody tr .nomor', function () {
      if(table.responsive.hasHidden()){
        var cust = table.row(this).data();
        $('[name="nomor[' + cust.nosj + ']"]').val($(this).val());
      }
    });

    $('#data_update_table').on('keyup blur', 'tbody tr .nominal', function () {
      if(table.responsive.hasHidden()){
        var cust = table.row(this).data();
        $('[name="nominal[' + cust.nosj + ']"]').val($(this).val());
      }
    });

    $('#data_update_table').on('keyup blur', 'tbody tr .keterangan_penagihan', function () {
      if(table.responsive.hasHidden()){
        var cust = table.row(this).data();
        $('[name="keterangan_penagihan[' + cust.nosj + ']"]').val($(this).val());
      }
    });
