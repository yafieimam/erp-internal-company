...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = $('#data_rencana_penyerahan_table').DataTable({
      ...
      ajax: {
        url:'{{ url("admin/trunojoyo/rencana_penyerahan/table") }}',
    ...
    function load_data_penyerahan_final(from_date = '', to_date = '')
    {
      table = $('#data_penyerahan_final_table').DataTable({
        ...
        lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
        ajax: {
          url:'{{ url("admin/trunojoyo/penyerahan_final/table") }}',
          data:{from_date:from_date, to_date:to_date},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
      ...
      table = $('#data_sorting_table').DataTable({
        ...
        },
        {
          ...
          render: function ( data, type, row)
          {
            ...
            return '<input type="text" name="jadwal[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.tanggal_jadwal_penyerahan).html() + '">';
          }
        },
        {
          data:'keterangan_jadwal_penyerahan',
          ...
          render: function ( data, type, row)
          {
            return '<textarea rows="2" name="keterangan_jadwal[' + $('<div />').text(row.nosj).html() + ']" style="width:100%;">' + $('<div />').text(row.keterangan_jadwal_penyerahan).html() + '</textarea>';
          }
        }
        ]
      });
      ...
      table = $('#data_edit_table').DataTable({
        ...
        },
        {
          ...
          render: function ( data, type, row)
          {
            ...
            return '<input type="text" name="edit_jadwal[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.tanggal_jadwal_penyerahan).html() + '">';
          }
        },
        {
          data:'keterangan_jadwal_penyerahan',
          ...
          render: function ( data, type, row)
          {
            return '<textarea rows="2" name="edit_keterangan_jadwal[' + $('<div />').text(row.nosj).html() + ']" style="width:100%;">' + $('<div />').text(row.keterangan_jadwal_penyerahan).html() + '</textarea>';
          }
        }
        ]
      });
    ...
    function load_data_update(tanggal = '')
    {
      table = $('#data_update_table').DataTable({
        ...
        },
        {
          ...
          render: function ( data, type, row)
          {
            $('[name="terima_dokumen[' + $('<div />').text(row.nosj).html() + ']"]').flatpickr({
              allowInput: true,
              disableMobile: true
            });

            return '<input type="text" name="terima_dokumen[' + $('<div />').text(row.nosj).html() + ']" value="' + $('<div />').text(row.tanggal_terima_dokumen_cust).html() + '" style="width:100%;">';
          }
        },
        {
          data:'keterangan_penerimaan',
          ...
          render: function ( data, type, row)
          {
            return '<textarea rows="2" name="keterangan_penerimaan[' + $('<div />').text(row.nosj).html() + ']" style="width:100%;">' + $('<div />').text(row.keterangan_penerimaan).html() + '</textarea>';
          }
        },
        ]
      });
