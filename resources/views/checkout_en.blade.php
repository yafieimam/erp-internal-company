...
@section('nav')
            <div class="bahasa">
                <p>
                  <a href="{{ url('en/checkout') }}"><span class="active">EN</span></a>
                  &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                  <a href="{{ url('id/checkout') }}"><span class="">IN</span></a>
                </p>
            </div>
@endsection
            ...
            <div class="col-sm-10">
              <div class="view-product">
                <div class="product-information"><!--/product-information-->
                  ...
                  <p><b>Phone:</b> {{ $data_order->phone }}</p>
                  <p align="justify"><b>Address:</b> {{ $data_order->address }}</p>
                  <p><b>City:</b> {{ $data_order->city }}</p>
            ...
            <div class="col-sm-4">
              <div class="view-product">
                <div class="product-information" style="padding-left: 10px; padding-right: 10px;"><!--/product-information-->
                  ...
                  <hr>
                  <p><b>Total Price: {{ number_format($data_order->total_harga,2,',','.') }}</b></p>
                  <hr>
                  <p><b>Total Bill: {{ number_format($data_order->total_harga,2,',','.') }}</b></p>
