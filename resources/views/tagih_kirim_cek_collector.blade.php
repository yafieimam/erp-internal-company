...
@section('title')
<title>KIRIM CEK / GIRO - PT. DWI SELO GIRI MAS</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Kirim Cek / Giro</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/homepage') }}">Home</a></li>
            <li class="breadcrumb-item">Penagihan</li>
            <li class="breadcrumb-item">Kirim Cek / Giro</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = $('#data_kirim_table').DataTable({
         ...
         ajax: {
          url:'{{ url("penagihan/kirim_cek_collector/table") }}',
    ...
    function load_data_terkirim(from_date = '', to_date = '')
    {
      table = $('#data_terkirim_table').DataTable({
        ...
        lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
        ajax: {
          url:'{{ url("penagihan/terkirim_cek_collector/table") }}',
          data:{from_date:from_date, to_date:to_date},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
    ...
    function load_data_kirim_detail(tanggal = '')
    {
      table = $('#detail_data_kirim_table').DataTable({
        ...
        bInfo : false,
        ajax: {
          url:'{{ url("penagihan/kirim_cek_collector/detail/table") }}',
    ...
    $('#btn-save-data').click( function() {
      ...
      $.ajax({
        ...
        type: "POST",
        url: '{{ url("penagihan/update/kirim_cek/collector") }}',
        dataSrc : 'data',
        dataType: 'JSON',
        data: data,
        async: 'false',
