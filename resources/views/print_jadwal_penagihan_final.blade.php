...
<head>
    ...
    <title>Print Jadwal Penagihan Final</title>
...
<body>
    <h2>Jadwal Penagihan Final Tanggal {{ date('j F Y', strtotime($data[0]->tanggal_jadwal_penagihan)) }}</h2>
    <?php $count = 0 ?>
    <table style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                @if($data->keterangan_jadwal_penagihan != null || $data->keterangan_jadwal_penagihan != '')
                <td>{{ $data->keterangan_jadwal_penagihan }}</td>
                @else
                <td>-</td>
                @endif
            </tr>
