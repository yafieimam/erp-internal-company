...
<body>
    ...
    @foreach($data as $data)
            ...
            <tr>
                <td>
                    <tr>
                        ...
                        <td style="font-size: 12px; font-weight: 0; width: 25%; border-bottom: 1px solid #000;">{{ $data->nomor_quotation }}
                    ...
                    <tr>
                        ...
                        <td style="font-size: 12px; font-weight: 0; width: 20%; border-bottom: 1px solid #000;">{{ date('j F Y', strtotime($data->tanggal_quotation)) }}</td>
                    </tr>
                    <tr>
        ...
        <table style="width: 100%;">
            <tr>
                <td style="font-size: 20px; font-family: 'Times New Roman'; font-weight: 900; text-align: center; text-decoration: underline;">QUOTATION</td>
            </tr>
        </table>
        <br><br>
        <table style="width: 100%;">
            <tr>
                ...
                <td style="font-size: 12px; font-weight: 0; border-bottom: 1px solid #000; width: 40%;">{{ $data->custname_quotation }}</td>
                <td style="font-size: 12px; font-weight: 0; width: 15%; text-align: right;">Kd Cust :</td>
            ...
            <tr>
                ...
                <td style="font-size: 12px; font-weight: 0; border-bottom: 1px solid #000; width: 40%;">{{ $data->address_quotation }}</td>
                <td style="font-size: 12px; font-weight: 0; width: 15%; text-align: right;">Pemesan :</td>
            ...
            <tr>
                ...
                <td style="font-size: 12px; font-weight: 0; border-bottom: 1px solid #000; width: 40%;">{{ $data->nomor_po }}</td>
            </tr>
        </table>
        <br>
        <table style="font-size: 12px; font-weight: 0; width: 100%; text-align: center; border-collapse: collapse;">
            ...
            {{ $sum = 0 }}
            {{ $sum_noppn = 0 }}
            {{ $keterangan_quotation = "" }}
            @foreach($products as $prod)
                <tr style="">
                    <td style="width: 20%; border-right: 1px solid #000; padding: 5px;">{{ $prod->nama_produk }} [{{ $prod->kode_produk }}]</td>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td style="font-size: 12px; font-weight: 0; border-bottom: 1px solid #000; width: 50%;">{{ $data->custalamat_receive . ', ' . ucwords(strtolower($data->kota_receive)) }}</td>
            </tr>
            <tr>
                <td style="font-size: 12px; font-weight: 0; width: 15%;">Keterangan Lain-lain :</td>
                <td style="font-size: 12px; font-weight: 0; border-bottom: 1px solid #000; width: 50%;">{{ $data->keterangan_quotation }}</td>
            </tr>
        </table>
        <br>
