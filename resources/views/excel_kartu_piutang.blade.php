...
<head>
    ...
    <title>Excel Kartu Piutang</title>
...
<body>
    <table style="width: 100%;" class="table table-bordered table-hover responsive">
        <tr>
            <th colspan="9" style="text-align: center; font-size: 16px;">PT. DWI SELO GIRI MAS</th>
        </tr>
        <tr>
            <th colspan="9" style="text-align: center; font-size: 12px;">Laporan Kartu Piutang</th>
        </tr>
        <tr>
            <td colspan="9" style="text-align: center; font-size: 12px;">Tanggal : {{ $from_date }} s.d {{ $to_date }}</td>
        </tr>
    </table>
    ...
    <table style="width: 100%;" class="table table-bordered table-hover responsive">
        ...
        @if($cek_cust)
            <tr>
                <td style="font-size: 12px;">KETERANGAN PELANGGAN</td>
            </tr>
            <tr>
                <td style="font-size: 12px;">{{ $data_cust->custid }}</td>
                <td style="font-size: 12px;"></td>
                <td style="font-size: 12px;"></td>
                <td style="font-size: 12px;"></td>
                <td style="font-size: 12px;">{{ $data_cust->custname }}</td>
                <td style="font-size: 12px;"></td>
                <td style="font-size: 12px;">Kontak Phone : {{ $data_cust->phone }}</td>
            </tr>
            <tr>
                <td colspan="4" style="font-size: 12px;"></td>
                <td style="font-size: 12px;">{{ $data_cust->address }}</td>
            </tr>
        @else
            <tr>
                <td style="font-size: 12px;">SEMUA PELANGGAN</td>
            </tr>
        @endif
    </table>
    ...
    <table style="width: 100%;" class="table table-bordered table-hover responsive">
        ...
        <tr>
            ...
            <td>
                ...
                @else
                @if($data->nosj != null || $data->nosj != '')
                {{ $data->keterangan }} &nbsp;&nbsp;&nbsp; {{ $data_arr[$data->nosj][0]['qty'] }} &nbsp;&nbsp;&nbsp; {{ $data_arr[$data->nosj][0]['price'] }}
                @else
                {{ $data->keterangan }}
                @endif
                @endif
