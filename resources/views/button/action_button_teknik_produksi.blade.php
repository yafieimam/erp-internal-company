...
@else
<a href="javascript:void(0)" data-id="{{ $tanggal_laporan_produksi }}" class="add btn btn-sm btn-primary" name="btn_input_data" id="btn_input_data" style="margin-bottom: 10px;" data-toggle="modal" data-target="#modal_input_data">
    <i class="fa fa-edit"></i>
</a>
@endif