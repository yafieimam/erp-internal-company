...
<a href="{{ url('admin/trunojoyo/rencana_penagihan/print/' . Illuminate\Support\Facades\Crypt::encrypt($tanggal_do)) }}" target="_blank" class="print btn btn-sm btn-primary" id="btn-print-rencana" style="margin-bottom: 10px;">
