    ...
    <div class="container">
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center">Rekomendasi Untuk Anda</h2>
            <div class="col-sm-3">
          ...
          <div class="features_items"><!--features_items-->
            ...
            <div class="col-sm-3">
              <div class="product-image-wrapper">
                <div class="single-products">
                  <div class="productinfo text-center">
                    <a href="{{ route('order_detail_id', ['kode_produk' => $data->kode_produk_komputer]) }}"><img src="{{asset('app-assets/images/' . $data->gambar)}}" alt="" /> </a>
                    <h2>Rp {{ number_format($data->harga,2,',','.') }}</h2>
                    <p>{{ $data->nama_produk }}</p>
                    <a href="{{ route('order_detail_id', ['kode_produk' => $data->kode_produk_komputer]) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Beli / Lihat Detail</a>
                  </div>
                  <div class="product-overlay">
                    <div class="overlay-content">
                      <h2>Rp {{ number_format($data->harga,2,',','.') }}</h2>
