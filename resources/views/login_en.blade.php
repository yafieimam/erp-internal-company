...
@section('title')
<title>LOGIN - PT. DWI SELO GIRI MAS</title>
@endsection
...
@section('nav')
            <div class="bahasa">
                <p>
                  <a href="{{ url('en/login') }}"><span class="active">EN</span></a>
                  &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                  <a href="{{ url('id/login') }}"><span class="">IN</span></a>
                </p>
            </div>
@endsection
...
<div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100 p-t-20">
        <form class="login100-form validate-form flex-sb flex-w" action="{{ url('/loginPostEn') }}" method="post">
          {{ csrf_field() }}
        ...
        <div class="flex-sb-m w-full p-t-3 p-b-24 wow fadeInUp">
            <div class="contact100-form-checkbox">
              Don't have an account? <a href="{{ url('en/register') }}" class="txt1">Sign Up Here</a>
            </div>
          </div>
      </div>
    </div>
