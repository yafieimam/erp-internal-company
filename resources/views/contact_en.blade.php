...
@section('title')
<title>CONTACT - PT. DWI SELO GIRI MAS</title>
@endsection

@section('nav')
            <div class="bahasa">
                <p>
                  <a href="{{ url('en/contact') }}"><span class="active">EN</span></a>
                  &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                  <a href="{{ url('id/contact') }}"><span class="">IN</span></a>
                </p>
            </div>
@endsection
            ...
            <div class="breadcrumb wow fadeInUp">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ url('en/contact') }}">CONTACT</a></li>
                </ol>
              </nav>
            </div>
          </div>
  ...
  <div class="prelative container">
    ...
    <form enctype="multipart/form-data" class="py-5 form-" id="yw0" action="{{ url('en/form-contact/process') }}" method="post">   
      ...
      <div class="row default text-area">
        <div class="col-md-60">
          <textarea class="form-control" placeholder="Notes / Messages" name="form_contact_message" id="form_contact_message">{{ old('form_contact_message') }}</textarea>        </div>
      </div>
