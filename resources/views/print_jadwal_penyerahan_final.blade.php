...
<head>
    ...
    <title>Print Jadwal Penyerahan Dokumen Final</title>
...
<body>
    <h2>Jadwal Penyerahan Dokumen Tanggal {{ date('j F Y', strtotime($data[0]->tanggal_jadwal_penyerahan)) }}</h2>
    <?php $count = 0 ?>
    <table style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                @if($data->keterangan_jadwal_penyerahan != null || $data->keterangan_jadwal_penyerahan != '')
                <td>{{ $data->keterangan_jadwal_penyerahan }}</td>
                @else
                <td>-</td>
                @endif
            </tr>
