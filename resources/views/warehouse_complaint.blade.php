...
<style type="text/css">
  ...
  #save_input_komitmen_ware, #save_new_edit_komitmen_ware, #save_edit_komitmen_ware{
    right: 20%;
    position: absolute;
    top: 23%;
    width: 60%;
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body" id="complaint_warehouse">
          <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
            ...
            ?>
            <li class="nav-item">
              <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#semua_warehouse_admin" role="tab" aria-controls="custom-content-home-profile" aria-selected="true">Semua</a>
            </li>
            <?php
              }else{
            ?>
            <li class="nav-item">
              <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#semua_warehouse" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Semua</a>
            </li>
            <?php
              }
            }
            ?>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#proses_warehouse" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Proses</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#diproses_warehouse" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Sedang Diproses</a>
            </li>
            <?php
              if(Session::get('login_admin')){
                if(Session::get('tipe_user') == 1){
            ?>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#valid_warehouse" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Validasi</a>
            </li>
            <?php
              }
            }
            ?>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-messages-tab" data-toggle="pill" href="#selesai_warehouse" role="tab" aria-controls="custom-content-below-messages" aria-selected="false">Selesai</a>
            </li>
          </ul>
          <div class="tab-content" id="custom-content-below-tabContent">
           <?php
            if(Session::get('login_admin')){
              if(Session::get('tipe_user') == 1){
            ?>
           <div class="tab-pane fade show active" id="semua_warehouse_admin" role="tabpanel" aria-labelledby="custom-content-below-home-tab" style="margin-top: 40px;">
              <table id="complaint_warehouse_semua_admin_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
           ...
           ?>
           <div class="tab-pane fade show active" id="semua_warehouse" role="tabpanel" aria-labelledby="custom-content-below-home-tab" style="margin-top: 40px;">
              <table id="complaint_warehouse_semua_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           ?>
           <div class="tab-pane fade" id="proses_warehouse" role="tabpanel" aria-labelledby="custom-content-below-profile-tab" style="margin-top: 40px;">
             <table id="complaint_warehouse_proses_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           <div class="tab-pane fade" id="diproses_warehouse" role="tabpanel" aria-labelledby="custom-content-below-profile-tab" style="margin-top: 40px;">
             <table id="complaint_warehouse_diproses_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           <div class="tab-pane fade" id="valid_warehouse" role="tabpanel" aria-labelledby="custom-content-below-messages-tab" style="margin-top: 40px;">
             <table id="complaint_warehouse_valid_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           <div class="tab-pane fade" id="selesai_warehouse" role="tabpanel" aria-labelledby="custom-content-below-messages-tab" style="margin-top: 40px;">
             <table id="complaint_warehouse_selesai_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
...
<div class="modal fade" id="modal_proses_complaint_warehouse">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Proses Complaint Warehouse</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" class="warehouseform" id="warehouseform" action="javascript:void(0)" enctype="multipart/form-data">
          {{ csrf_field() }}
      <div class="modal-body">
        <div class="form-group">
          <input class="form-control" type="hidden" name="nomor_complaint_ware" id="nomor_complaint_ware" />
        </div>
        <div class="form-group">
          <input class="form-control" type="hidden" name="custid_ware" id="custid_ware" />
        </div>
        <div class="form-group">
          <input class="form-control" type="hidden" name="no_divisi_ware" id="no_divisi_ware" />
        </div>
        <div class="row"> 
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      <label for="area_ware">Area</label>
                      <select id="area_ware" name="area_ware" class="form-control" disabled>
                ...
                <div class="row">
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      <label for="supervisor_ware">Supervisor</label>
                      <input class="form-control" type="text" name="supervisor_ware" id="supervisor_ware" placeholder="Supervisor" readonly/>
                    </div>
                  </div>
                </div>
                <div class="row">
        ...
        <div class="row">
          <div class="col-4">
            <div class="form-group">
              <label for="evaluasi_ware">Evaluasi</label>
              <textarea class="form-control" rows="3" name="evaluasi_ware" id="evaluasi_ware" placeholder="Evaluasi"></textarea>
            </div>
          </div>
          <div class="col-4">
            <div class="form-group">
              <label for="solusi_internal_ware">Solusi Internal</label>
              <textarea class="form-control" rows="3" name="solusi_internal_ware" id="solusi_internal_ware" placeholder="Solusi Internal"></textarea>
            </div>
          </div>
          <div class="col-4">
            <div class="form-group">
              <label for="upload_file_ware">Lampiran</label>
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="upload_file_ware" name="upload_file_ware">
                  <label class="custom-file-label" for="upload_file_ware">Choose file</label>
                </div>
              </div>
            </div>
          ...
          <div class="col-6" style="display: none;">
            <div class="form-group">
              <label for="solusi_customer_ware">Solusi Customer</label>
              <textarea class="form-control" rows="5" name="solusi_customer_ware" id="solusi_customer_ware" placeholder="Solusi Customer"></textarea>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-5">
            <div class="form-group">
              <label for="komitmen_ware">Tindakan / Komitmen</label>
              <textarea class="form-control" rows="3" name="komitmen_ware" id="komitmen_ware" placeholder="Tindakan / Komitmen"></textarea>
            </div>
          </div>
          <div class="col-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="selesai_tanggal_komitmen_ware" id="selesai_tanggal_komitmen_ware" autocomplete="off" placeholder="Selesai Tanggal">
              </div>
              <!-- /.input group -->
            </div>
          </div>
          <div class="col-2">
            <div class="form-group">
              <label>&nbsp</label>
              <button type="button" class="btn btn-success" id="save_input_komitmen_ware">Save</button>
            </div>
          </div>
        </div>
        <table id="list_komitmen_ware_table" style="width: 100%;" class="table table-bordered table-hover">
          <thead>
            <tr>
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-danger" id="btn_tidak_terlibat_ware" data-dismiss="modal" data-toggle="modal" data-target="#modal_alasan_tidak_terlibat">Tidak Terlibat</button>
        <button type="button" class="btn btn-success" id="btn_terlibat_ware" style="display: none;">Terlibat</button>
        <button type="submit" class="btn btn-primary" id="btn_save_ware">Save</button>
      </div>
    </form>
    </div>
    <!-- /.modal-content -->
...
<div class="modal fade" id="modal_alasan_tidak_terlibat">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal" data-toggle="modal" data-target="#modal_proses_complaint_warehouse">Close</button>
...
<div class="modal fade" id="modal_edit_complaint_warehouse">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Edit Complaint Warehouse</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" class="editwarehouseform" id="editwarehouseform" action="javascript:void(0)" enctype="multipart/form-data">
          {{ csrf_field() }}
      <div class="modal-body">
        <div class="form-group">
          <input class="form-control" type="hidden" name="edit_nomor_complaint_ware" id="edit_nomor_complaint_ware" />
        </div>
        <div class="form-group">
          <input class="form-control" type="hidden" name="edit_custid_ware" id="edit_custid_ware" />
        </div>
        <div class="row">
          <div class="col-5">
            <div class="form-group">
              <label for="edit_upload_file_ware">Ubah Lampiran</label>
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="edit_upload_file_ware" name="edit_upload_file_ware">
                  <label class="custom-file-label" for="edit_upload_file_ware">Choose file</label>
                </div>
              </div>
            </div>
            <p style="font-weight: 700;">Format File Allowed only .jpg, .jpeg, or .pdf <br>Max Size of File is 2 MB.</p>
          ...
          <div class="col-3">
            <div class="form-group">
              ...
              <div class="custom-control custom-radio radio-control">
                <a target="_blank" id="lihat_lampiran_ware" class="btn btn-primary save-btn-in">Lihat Lampiran</a>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-6">
            <div class="form-group">
              <label for="edit_evaluasi_ware">Evaluasi</label>
              <textarea class="form-control" rows="3" name="edit_evaluasi_ware" id="edit_evaluasi_ware" placeholder="Evaluasi"></textarea>
            </div>
          </div>
          <div class="col-6">
            <div class="form-group">
              <label for="edit_solusi_internal_ware">Solusi Internal</label>
              <textarea class="form-control" rows="3" name="edit_solusi_internal_ware" id="edit_solusi_internal_ware" placeholder="Solusi Internal"></textarea>
            </div>
          </div>
        </div>
        <div class="row" id="div_edit_komitmen_ware">
          <div class="col-5">
            <div class="form-group">
              <label for="edit_komitmen_ware">Tindakan / Komitmen</label>
              <textarea class="form-control" rows="3" name="edit_komitmen_ware" id="edit_komitmen_ware" placeholder="Tindakan / Komitmen"></textarea>
            </div>
          </div>
          <div class="col-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="edit_selesai_tanggal_komitmen_ware" id="edit_selesai_tanggal_komitmen_ware" autocomplete="off" placeholder="Finish Date Komitmen">
              </div>
              <!-- /.input group -->
            </div>
          </div>
          <textarea class="form-control" name="edit_komitmen_lama_ware" id="edit_komitmen_lama_ware" style="display: none;"></textarea>
          <input type="hidden" class="form-control" name="edit_selesai_tanggal_komitmen_lama_ware" id="edit_selesai_tanggal_komitmen_lama_ware" autocomplete="off">
          <div class="col-2">
            <div class="form-group">
              <label>&nbsp</label>
              <button type="button" class="btn btn-success save-btn-in" id="save_new_edit_komitmen_ware">Save</button>
              <button type="button" class="btn btn-success save-btn-in" id="save_edit_komitmen_ware" style="display: none;">Edit</button>
            </div>
          </div>
        </div>
        <table id="edit_list_komitmen_ware_table" style="width: 100%;" class="table table-bordered table-hover responsive">
          <thead>
            <tr>
              <th>Tanggal Selesai</th>
              <th>Komitmen</th>
        ...
        <div class="row">
          <div class="col-6" style="display: none;">
            <div class="form-group">
              <label for="edit_solusi_customer_ware">Solusi Customer</label>
              <textarea class="form-control" rows="3" name="edit_solusi_customer_ware" id="edit_solusi_customer_ware" placeholder="Solusi Customer"></textarea>
            </div>
          </div>
        </div>
      </div>
...
<!--   <script src="{{asset('lte/plugins/datatables/jquery.dataTables.js')}}"></script>
  ...
  <script>
    $(document).ready(function(){
      ...
      var table = $('#complaint_warehouse_semua_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/warehouse/semua") }}',
        data : function( d ) {
          d.nomor = any_nomor;
        }
       },
      ...
      if(any_nomor != '' && type == 8){
        table.ajax.url('{{ url("complaint_warehouse/specific") }}').load();
      }

      if(tipe_user == 1){
        $('#complaint_warehouse_semua_admin_table').DataTable().destroy();
        load_data_warehouse_semua_admin();
      }
      $('.nav-tabs a').on('shown.bs.tab', function (e) {
        target = $(e.target).attr("href");
        if(target == '#semua_warehouse'){
          $('#complaint_warehouse_semua_table').DataTable().destroy();
          load_data_warehouse_semua();
        }else if(target == '#semua_warehouse_admin'){
          $('#complaint_warehouse_semua_admin_table').DataTable().destroy();
          load_data_warehouse_semua_admin();
        }else if(target == '#proses_warehouse'){
          $('#complaint_warehouse_proses_table').DataTable().destroy();
          load_data_warehouse_proses();
        }else if(target == '#diproses_warehouse'){
          $('#complaint_warehouse_diproses_table').DataTable().destroy();
          load_data_warehouse_diproses();
        }else if(target == '#valid_warehouse'){
          $('#complaint_warehouse_valid_table').DataTable().destroy();
          load_data_warehouse_valid();
        }else if(target == '#selesai_warehouse'){
          $('#complaint_warehouse_selesai_table').DataTable().destroy();
          load_data_warehouse_selesai();
        }
      });
    ...
    function load_data_komitmen()
      {
        table = $('#list_komitmen_table').DataTable({
         ...
         lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
         ajax: {
          url:'{{ url("warehouse_complaint/list_komitmen") }}',
    ...
    function load_data_warehouse_semua(from_date = '', to_date = '')
     {
      table = $('#complaint_warehouse_semua_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
     ...
     function load_data_warehouse_semua_admin(from_date = '', to_date = '')
     {
      table = $('#complaint_warehouse_semua_admin_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/warehouse/semua_admin") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_warehouse_proses(from_date = '', to_date = '')
     {
      table = $('#complaint_warehouse_proses_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/warehouse/proses") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_warehouse_diproses(from_date = '', to_date = '')
     {
      table = $('#complaint_warehouse_diproses_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/warehouse/diproses") }}',
        data:{from_date:from_date, to_date:to_date},
        error: function(jqXHR, ajaxOptions, thrownError) {
          alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
        }
     ...
     function load_data_warehouse_valid(from_date = '', to_date = '')
     {
      table = $('#complaint_warehouse_valid_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/warehouse/valid") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_warehouse_selesai(from_date = '', to_date = '')
     {
      table = $('#complaint_warehouse_selesai_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/warehouse/selesai") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
    ...
    $('#filter').click(function(){
      ...
      if(from_date != '' &&  to_date != '')
      {
        if(tipe_user == 1){
          $('#complaint_warehouse_semua_admin_table').DataTable().destroy();
          load_data_warehouse_semua_admin(from_date, to_date);
        }else{
          $('#complaint_warehouse_semua_table').DataTable().destroy();
          load_data_warehouse_semua(from_date, to_date);
        }
        if(target == '#semua_warehouse'){
          $('#complaint_warehouse_semua_table').DataTable().destroy();
          load_data_warehouse_semua(from_date, to_date);
          ...
          $('#complaint_warehouse_proses_table').DataTable().destroy();
          load_data_warehouse_proses(from_date, to_date);
        }else if(target == '#diproses_warehouse'){
          $('#complaint_warehouse_diproses_table').DataTable().destroy();
          load_data_warehouse_diproses(from_date, to_date);
        }else if(target == '#valid_warehouse'){
          $('#complaint_warehouse_valid_table').DataTable().destroy();
          load_data_warehouse_valid(from_date, to_date);
        }else if(target == '#selesai_warehouse'){
          $('#complaint_warehouse_selesai_table').DataTable().destroy();
          load_data_warehouse_selesai(from_date, to_date);
        }
      }
      else
      {
...
<script type="text/javascript">
  $(function () {
    ...
    $('#selesai_tanggal_komitmen_ware').flatpickr({
      allowInput: true,
      disableMobile: true
    });

    $('#edit_selesai_tanggal_komitmen_ware').flatpickr({
      allowInput: true,
      disableMobile: true
    });
...
<script type="text/javascript">
  $(document).ready(function(event){
    ...
    function load_data_komitmen(no_complaint = '')
      ...
      function load_komitmen_ware(no_complaint = '')
      {
        table = $('#list_komitmen_ware_table').DataTable({
         processing: true,
         serverSide: true,
         language: {
         ...
         ajax: {
          url:'{{ url("list_komitmen_temp/warehouse") }}',
          data:{no_complaint:no_complaint},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
      ...
      function load_edit_komitmen_ware(no_complaint = '')
      {
        table = $('#edit_list_komitmen_ware_table').DataTable({
         processing: true,
         serverSide: true,
         language: {
            emptyTable: "Tambahkan Data Komitmen"
         ...
         ajax: {
          url:'{{ url("edit_list_komitmen_warehouse") }}',
          data:{no_complaint:no_complaint},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
    ...
    $('body').on('click', '#proses_complaint_warehouse', function () {
      var complaint = $(this).data('id');
      var custid_prd = $(this).data('custid');
      var divisi = $(this).data('divisi');
      $('#nomor_complaint_ware').val(complaint);
      $('#custid_ware').val(custid_prd);
      $('#no_divisi_ware').val(divisi);

      $('#list_komitmen_ware_table').DataTable().destroy();
      load_komitmen_ware(complaint);

      var url = "{{ url('logistik_proses/show/no_complaint') }}";
      url = url.replace('no_complaint', enc(complaint.toString()));
      $('#tanggal_pengiriman').val('');
      $('#tanggal_order').val('');
      $('#area_ware').val('').trigger('change');
      $('#no_kendaraan').val('');
      $('#nama_supir').val('');
      $('#nama_kernet').val('');
      ...
      $.get(url, function (data) {
        ...
        if(data.area == '' || data.area == null){
          ...
          $('#area_ware').val(data.area).trigger('change');
        }
        ...
        $('#supervisor_ware').val(data.supervisor);
      ...
      if(divisi == 1){
        $('#warehouseform input[type="text"]'). prop("disabled", true);
        $('#warehouseform input[type="file"]'). prop("disabled", true);
        $('#warehouseform textarea'). prop("disabled", true);
        $('#btn_save_ware').hide();
        $('#btn_tidak_terlibat_ware').hide();
        $('#btn_terlibat_ware').show();
      }else{
        $('#warehouseform input[type="text"]'). prop("disabled", false);
        $('#warehouseform input[type="file"]'). prop("disabled", false);
        $('#warehouseform textarea'). prop("disabled", false);
        $('#btn_save_ware').show();
        $('#btn_tidak_terlibat_ware').show();
        $('#btn_terlibat_ware').hide();
      }
    });

    $('body').on('click', '#save_input_komitmen_ware', function () {
      var selesai_tanggal_komitmen = $('#selesai_tanggal_komitmen_ware').val();
      var komitmen = $('#komitmen_ware').val();
      var nomor_complaint = $('#nomor_complaint_ware').val();

      $.ajax({
        type: "GET",
        url: "{{ url('save_data_komitmen_ware') }}",
        data: { 'selesai_tanggal_komitmen' : selesai_tanggal_komitmen, 'komitmen' : komitmen, 'nomor_complaint' : nomor_complaint },
        success: function (data) {
          $('#selesai_tanggal_komitmen_ware').val('');
          $('#komitmen_ware').val('');
          var oTable = $('#list_komitmen_ware_table').dataTable();
          oTable.fnDraw(false);
        },
        error: function (data) {  
          var oTable = $('#list_komitmen_ware_table').dataTable();
    ...
    $('body').on('click', '#btn_tidak_terlibat_ware', function () {
      var complaint = $('#nomor_complaint_ware').val();
      $('#nomor_complaint_alasan').val(complaint);
    });

    $('body').on('click', '#btn_terlibat_ware', function () {
      var complaint = $('#nomor_complaint_ware').val();
      var custid = $('#custid_ware').val();
      var divisi = $('#no_divisi_ware').val();

      if(confirm("Apakah Anda Yakin?")){
        $.ajax({
          type: "GET",
          url: "{{ url('complaint_warehouse/terlibat/') }}",
          data: { 'nomor_complaint' : complaint, 'divisi' : divisi },
          success: function (data) {
            var oTablea = $('#complaint_warehouse_semua_table').dataTable();
            oTablea.fnDraw(false);
            var oTableb = $('#complaint_warehouse_proses_table').dataTable();
            oTableb.fnDraw(false);
            var oTablec = $('#complaint_warehouse_valid_table').dataTable();
            oTablec.fnDraw(false);
            var oTabled = $('#complaint_warehouse_selesai_table').dataTable();
            oTabled.fnDraw(false);
            var oTablee = $('#complaint_warehouse_semua_admin_table').dataTable();
            oTablee.fnDraw(false);
            var oTablef = $('#complaint_warehouse_diproses_table').dataTable();
            oTablef.fnDraw(false);
            $("#modal_proses_complaint_warehouse").modal('hide');
            $("#modal_proses_complaint_warehouse").trigger('click');
    ...
    $('body').on('click', '#edit_complaint_warehouse', function () {
      var complaint = $(this).data('id');
      var custid_ware = $(this).data('custid');
      $('#edit_nomor_complaint_ware').val(complaint);
      $('#edit_custid_ware').val(custid_ware);
      var url = "{{ url('complaint_warehouse/show/edit/no_complaint') }}";
      url = url.replace('no_complaint', enc(complaint.toString()));
      $('#edit_upload_file_ware').html('');
      $('#edit_evaluasi_ware').html('');
      $('#edit_solusi_customer_ware').html('');
      $('#edit_solusi_internal_ware').html('');
      $('#edit_komitmen_ware').html('');
      $('#edit_selesai_tanggal_komitmen_ware').html('');
      $.get(url, function (data) {
        $('#edit_evaluasi_ware').html(data.evaluasi);
        $('#edit_solusi_customer_ware').html(data.solusi_customer);
        $('#edit_solusi_internal_ware').html(data.solusi_internal);
        $('#edit_list_komitmen_ware_table').DataTable().destroy();
        load_edit_komitmen_ware(complaint);
        if(data.lampiran == null){
          $('#lihat_lampiran_ware').html('No Lampiran');
          $('#lihat_lampiran_ware').addClass('disabled');
          $('#lihat_lampiran_ware').attr('href', '#');
        }else{
          $('#lihat_lampiran_ware').html('Lihat Lampiran');
          $('#lihat_lampiran_ware').removeClass('disabled');
          $('#lihat_lampiran_ware').attr('href', '../data_file/' + data.lampiran);
        }
      })
    });

    $('body').on('click', '#save_new_edit_komitmen_ware', function () {
      var selesai_tanggal_komitmen = $('#edit_selesai_tanggal_komitmen_ware').val();
      var komitmen = $('#edit_komitmen_ware').val();
      var nomor_complaint = $('#edit_nomor_complaint_ware').val();

      $.ajax({
        type: "GET",
        url: "{{ url('save_new_edit_komitmen_ware') }}",
        data: { 'selesai_tanggal_komitmen' : selesai_tanggal_komitmen, 'komitmen' : komitmen, 'nomor_complaint' : nomor_complaint },
        success: function (data) {
          $('#edit_selesai_tanggal_komitmen_ware').val('');
          $('#edit_komitmen_ware').val('');
          var oTable = $('#edit_list_komitmen_ware_table').dataTable();
          oTable.fnDraw(false);
        },
        error: function (data) {  
          var oTable = $('#edit_list_komitmen_ware_table').dataTable();
    ...
    $('body').on('click', '#edit-komitmen', function () {
      ...
      $('#edit_komitmen_ware').val('');
      $('#edit_selesai_tanggal_komitmen_ware').val('');
      $('#edit_komitmen_lama_ware').val('');
      $('#edit_selesai_tanggal_komitmen_lama_ware').val('');
      $('#save_edit_komitmen_ware').show();
      $('#save_new_edit_komitmen_ware').hide();
      $.get(url, function (data) {
        $('#edit_selesai_tanggal_komitmen_ware').val(data.selesai_tanggal_komitmen);
        $('#edit_komitmen_ware').val(data.komitmen);
        $('#edit_selesai_tanggal_komitmen_lama_ware').val(data.selesai_tanggal_komitmen);
        $('#edit_komitmen_lama_ware').val(data.komitmen);
      })
    });

    $('body').on('click', '#save_edit_komitmen_ware', function () {
      var selesai_tanggal_komitmen = $('#edit_selesai_tanggal_komitmen_ware').val();
      var komitmen = $('#edit_komitmen_ware').val();
      var selesai_tanggal_komitmen_lama = $('#edit_selesai_tanggal_komitmen_lama_ware').val();
      var komitmen_lama = $('#edit_komitmen_lama_ware').val();
      var nomor_complaint = $('#edit_nomor_complaint_ware').val();
      $.ajax({
        type: "GET",
        url: "{{ url('update_edit_komitmen_ware') }}",
        ...
        success: function (data) {
          ...
          $('#edit_komitmen_lama_ware').val('');
          $('#edit_selesai_tanggal_komitmen_lama_ware').val('');
          $('#save_edit_komitmen_ware').hide();
          $('#save_new_edit_komitmen_ware').show();
          var oTable = $('#edit_list_komitmen_ware_table').dataTable();
          oTable.fnDraw(false);
        },
        error: function (data) {
    ...
    $('body').on('click', '#validate_complaint_warehouse', function () {
      var nomor_complaint = $(this).data("id");
    ...
    $('body').on('click', '#validate_complaint', function () {
      ...
      if(confirm("Data Ini Akan Diubah Status Menjadi Done?")){
        $.ajax({
          ...
          data: { 'nomor_complaint' : nomor_complaint },
          success: function (data) {
            var oTableaa = $('#complaint_warehouse_semua_table').dataTable();
            oTableaa.fnDraw(false);
            var oTablebb = $('#complaint_warehouse_proses_table').dataTable();
            oTablebb.fnDraw(false);
            var oTablecc = $('#complaint_warehouse_valid_table').dataTable();
            oTablecc.fnDraw(false);
            var oTabledd = $('#complaint_warehouse_selesai_table').dataTable();
            oTabledd.fnDraw(false);
            var oTableee = $('#complaint_warehouse_semua_admin_table').dataTable();
            oTableee.fnDraw(false);
            var oTableff = $('#complaint_warehouse_diproses_table').dataTable();
  ...
  $(document).ready(function () {
    $('#alasantidakterlibatform').validate({
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          type:'POST',
          url: "{{ url('complaint_warehouse/tidak_terlibat') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success: function (data) {
    ...
    $('#warehouseform').validate({
      rules: {
        nomor_complaint_ware: {
          required: true,
        },
        custid_ware: {
          required: true,
        },
        solusi_internal_ware: {
          required: true,
        },
        upload_file_ware: {
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          type:'POST',
          url:"{{ url('/complaint_warehouse/store') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success:function(data){
    ...
    $('#editwarehouseform').validate({
      rules: {
        edit_nomor_complaint_ware: {
          required: true,
        },
        edit_custid_ware: {
          required: true,
        },
        edit_solusi_internal_ware: {
          required: true,
        },
        edit_upload_file_ware: {
          extension: "jpg,jpeg,pdf",
          filesize: 2,
        },
      },
      ...
      submitHandler: function(form) {
        var myform = document.getElementById("editwarehouseform");
        var formdata = new FormData(myform);

        $.ajax({
          type:'POST',
          url:"{{ url('/complaint_warehouse/edit') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success:function(data){
            ...
            var oTablee = $('#complaint_warehouse_semua_admin_table').dataTable();
            oTablee.fnDraw(false);
            $("#modal_edit_complaint_warehouse").modal('hide');
            $("#modal_edit_complaint_warehouse").trigger('click');
            alert("Data Successfully Stored");
          },
          error: function (data) {
            console.log('Error:', data);
