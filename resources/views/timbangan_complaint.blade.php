...
<style type="text/css">
  ...
  #save_input_komitmen_timbang, #save_new_edit_komitmen_timbang, #save_edit_komitmen_timbang{
    right: 20%;
    position: absolute;
    top: 23%;
    width: 60%;
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body" id="complaint_timbangan">
          <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
            ...
            ?>
            <li class="nav-item">
              <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#semua_timbangan_admin" role="tab" aria-controls="custom-content-home-profile" aria-selected="true">Semua</a>
            </li>
            <?php
              }else{
            ?>
            <li class="nav-item">
              <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#semua_timbangan" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Semua</a>
            </li>
            <?php
              }
            }
            ?>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#proses_timbangan" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Proses</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#diproses_timbangan" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Sedang Diproses</a>
            </li>
            <?php
              if(Session::get('login_admin')){
                if(Session::get('tipe_user') == 1){
            ?>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#valid_timbangan" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Validasi</a>
            </li>
            <?php
              }
            }
            ?>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-messages-tab" data-toggle="pill" href="#selesai_timbangan" role="tab" aria-controls="custom-content-below-messages" aria-selected="false">Selesai</a>
            </li>
          </ul>
          <div class="tab-content" id="custom-content-below-tabContent">
           <?php
            if(Session::get('login_admin')){
              if(Session::get('tipe_user') == 1){
            ?>
           <div class="tab-pane fade show active" id="semua_timbangan_admin" role="tabpanel" aria-labelledby="custom-content-below-home-tab" style="margin-top: 40px;">
              <table id="complaint_timbangan_semua_admin_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
           ...
           ?>
           <div class="tab-pane fade show active" id="semua_timbangan" role="tabpanel" aria-labelledby="custom-content-below-home-tab" style="margin-top: 40px;">
              <table id="complaint_timbangan_semua_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           ?>
           <div class="tab-pane fade" id="proses_timbangan" role="tabpanel" aria-labelledby="custom-content-below-profile-tab" style="margin-top: 40px;">
             <table id="complaint_timbangan_proses_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           <div class="tab-pane fade" id="diproses_timbangan" role="tabpanel" aria-labelledby="custom-content-below-profile-tab" style="margin-top: 40px;">
             <table id="complaint_timbangan_diproses_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           <div class="tab-pane fade" id="valid_timbangan" role="tabpanel" aria-labelledby="custom-content-below-messages-tab" style="margin-top: 40px;">
             <table id="complaint_timbangan_valid_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           <div class="tab-pane fade" id="selesai_timbangan" role="tabpanel" aria-labelledby="custom-content-below-messages-tab" style="margin-top: 40px;">
             <table id="complaint_timbangan_selesai_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
...
<div class="modal fade" id="modal_proses_complaint_timbangan">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Proses Complaint Timbangan</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" class="timbanganform" id="timbanganform" action="javascript:void(0)" enctype="multipart/form-data">
          {{ csrf_field() }}
      <div class="modal-body">
        <div class="form-group">
          <input class="form-control" type="hidden" name="nomor_complaint_timbang" id="nomor_complaint_timbang" />
        </div>
        <div class="form-group">
          <input class="form-control" type="hidden" name="custid_timbang" id="custid_timbang" />
        </div>
        <div class="form-group">
          <input class="form-control" type="hidden" name="no_divisi_timbang" id="no_divisi_timbang" />
        </div>
        <div class="row"> 
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      <label for="area_timbang">Area</label>
                      <select id="area_timbang" name="area_timbang" class="form-control" disabled>
                ...
                <div class="row">
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      <label for="supervisor_timbang">Supervisor</label>
                      <input class="form-control" type="text" name="supervisor_timbang" id="supervisor_timbang" placeholder="Supervisor" readonly/>
                    </div>
                  </div>
                </div>
                <div class="row">
        ...
        <div class="row">
          <div class="col-4">
            <div class="form-group">
              <label for="evaluasi_timbang">Evaluasi</label>
              <textarea class="form-control" rows="3" name="evaluasi_timbang" id="evaluasi_timbang" placeholder="Evaluasi"></textarea>
            </div>
          </div>
          <div class="col-4">
            <div class="form-group">
              <label for="solusi_internal_timbang">Solusi Internal</label>
              <textarea class="form-control" rows="3" name="solusi_internal_timbang" id="solusi_internal_timbang" placeholder="Solusi Internal"></textarea>
            </div>
          </div>
          <div class="col-4">
            <div class="form-group">
              <label for="upload_file_timbang">Lampiran</label>
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="upload_file_timbang" name="upload_file_timbang">
                  <label class="custom-file-label" for="upload_file_timbang">Choose file</label>
                </div>
              </div>
            </div>
          ...
          <div class="col-6" style="display: none;">
            <div class="form-group">
              <label for="solusi_customer_timbang">Solusi Customer</label>
              <textarea class="form-control" rows="5" name="solusi_customer_timbang" id="solusi_customer_timbang" placeholder="Solusi Customer"></textarea>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-5">
            <div class="form-group">
              <label for="komitmen_timbang">Tindakan / Komitmen</label>
              <textarea class="form-control" rows="3" name="komitmen_timbang" id="komitmen_timbang" placeholder="Tindakan / Komitmen"></textarea>
            </div>
          </div>
          <div class="col-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="selesai_tanggal_komitmen_timbang" id="selesai_tanggal_komitmen_timbang" autocomplete="off" placeholder="Selesai Tanggal">
              </div>
              <!-- /.input group -->
            </div>
          </div>
          <div class="col-2">
            <div class="form-group">
              <label>&nbsp</label>
              <button type="button" class="btn btn-success" id="save_input_komitmen_timbang">Save</button>
            </div>
          </div>
        </div>
        <table id="list_komitmen_timbang_table" style="width: 100%;" class="table table-bordered table-hover responsive">
          <thead>
            <tr>
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-danger" id="btn_tidak_terlibat_timbang" data-dismiss="modal" data-toggle="modal" data-target="#modal_alasan_tidak_terlibat">Tidak Terlibat</button>
        <button type="button" class="btn btn-success" id="btn_terlibat_timbang" style="display: none;">Terlibat</button>
        <button type="submit" class="btn btn-primary" id="btn_save_timbang">Save</button>
      </div>
    </form>
    </div>
    <!-- /.modal-content -->
...
<div class="modal fade" id="modal_alasan_tidak_terlibat">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal" data-toggle="modal" data-target="#modal_proses_complaint_timbangan">Close</button>
...
<div class="modal fade" id="modal_edit_complaint_timbangan">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Edit Complaint Timbangan</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" class="edittimbanganform" id="edittimbanganform" action="javascript:void(0)" enctype="multipart/form-data">
          {{ csrf_field() }}
      <div class="modal-body">
        <div class="form-group">
          <input class="form-control" type="hidden" name="edit_nomor_complaint_timbang" id="edit_nomor_complaint_timbang" />
        </div>
        <div class="form-group">
          <input class="form-control" type="hidden" name="edit_custid_timbang" id="edit_custid_timbang" />
        </div>
        <div class="row">
          <div class="col-5">
            <div class="form-group">
              <label for="edit_upload_file_timbang">Ubah Lampiran</label>
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="edit_upload_file_timbang" name="edit_upload_file_timbang">
                  <label class="custom-file-label" for="edit_upload_file_timbang">Choose file</label>
                </div>
              </div>
            </div>
            <p style="font-weight: 700;">Format File Allowed only .jpg, .jpeg, or .pdf <br>Max Size of File is 2 MB.</p>
          ...
          <div class="col-3">
            <div class="form-group">
              ...
              <div class="custom-control custom-radio radio-control">
                <a target="_blank" id="lihat_lampiran_timbang" class="btn btn-primary save-btn-in">Lihat Lampiran</a>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-6">
            <div class="form-group">
              <label for="edit_evaluasi_timbang">Evaluasi</label>
              <textarea class="form-control" rows="3" name="edit_evaluasi_timbang" id="edit_evaluasi_timbang" placeholder="Evaluasi"></textarea>
            </div>
          </div>
          <div class="col-6">
            <div class="form-group">
              <label for="edit_solusi_internal_timbang">Solusi Internal</label>
              <textarea class="form-control" rows="3" name="edit_solusi_internal_timbang" id="edit_solusi_internal_timbang" placeholder="Solusi Internal"></textarea>
            </div>
          </div>
        </div>
        <div class="row" id="div_edit_komitmen_timbang">
          <div class="col-5">
            <div class="form-group">
              <label for="edit_komitmen_timbang">Tindakan / Komitmen</label>
              <textarea class="form-control" rows="3" name="edit_komitmen_timbang" id="edit_komitmen_timbang" placeholder="Tindakan / Komitmen"></textarea>
            </div>
          </div>
          <div class="col-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="edit_selesai_tanggal_komitmen_timbang" id="edit_selesai_tanggal_komitmen_timbang" autocomplete="off" placeholder="Finish Date Komitmen">
              </div>
              <!-- /.input group -->
            </div>
          </div>
          <textarea class="form-control" name="edit_komitmen_lama_timbang" id="edit_komitmen_lama_timbang" style="display: none;"></textarea>
          <input type="hidden" class="form-control" name="edit_selesai_tanggal_komitmen_lama_timbang" id="edit_selesai_tanggal_komitmen_lama_timbang" autocomplete="off">
          <div class="col-2">
            <div class="form-group">
              <label>&nbsp</label>
              <button type="button" class="btn btn-success save-btn-in" id="save_new_edit_komitmen_timbang">Save</button>
              <button type="button" class="btn btn-success save-btn-in" id="save_edit_komitmen_timbang" style="display: none;">Edit</button>
            </div>
          </div>
        </div>
        <table id="edit_list_komitmen_timbang_table" style="width: 100%;" class="table table-bordered table-hover responsive">
          <thead>
            <tr>
              <th>Tanggal Selesai</th>
              <th>Komitmen</th>
        ...
        <div class="row">
          <div class="col-6" style="display: none;">
            <div class="form-group">
              <label for="edit_solusi_customer_timbang">Solusi Customer</label>
              <textarea class="form-control" rows="3" name="edit_solusi_customer_timbang" id="edit_solusi_customer_timbang" placeholder="Solusi Customer"></textarea>
            </div>
          </div>
        </div>
      </div>
...
<!--   <script src="{{asset('lte/plugins/datatables/jquery.dataTables.js')}}"></script>
  ...
  <script>
    $(document).ready(function(){
      ...
      var table = $('#complaint_timbangan_semua_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/timbangan/semua") }}',
        data : function( d ) {
          d.nomor = any_nomor;
        }
       },
      ...
      if(any_nomor != '' && type == 7){
        table.ajax.url('{{ url("complaint_timbangan/specific") }}').load();
      }

      if(tipe_user == 1){
        $('#complaint_timbangan_semua_admin_table').DataTable().destroy();
        load_data_timbangan_semua_admin();
      }
      $('.nav-tabs a').on('shown.bs.tab', function (e) {
        target = $(e.target).attr("href");
        if(target == '#semua_timbangan'){
          $('#complaint_timbangan_semua_table').DataTable().destroy();
          load_data_timbangan_semua();
        }else if(target == '#semua_timbangan_admin'){
          $('#complaint_timbangan_semua_admin_table').DataTable().destroy();
          load_data_timbangan_semua_admin();
        }else if(target == '#proses_timbangan'){
          $('#complaint_timbangan_proses_table').DataTable().destroy();
          load_data_timbangan_proses();
        }else if(target == '#diproses_timbangan'){
          $('#complaint_timbangan_diproses_table').DataTable().destroy();
          load_data_timbangan_diproses();
        }else if(target == '#valid_timbangan'){
          $('#complaint_timbangan_valid_table').DataTable().destroy();
          load_data_timbangan_valid();
        }else if(target == '#selesai_timbangan'){
          $('#complaint_timbangan_selesai_table').DataTable().destroy();
          load_data_timbangan_selesai();
        }
      });
    ...
    function load_data_komitmen()
      {
        table = $('#list_komitmen_table').DataTable({
         ...
         lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
         ajax: {
          url:'{{ url("timbangan_complaint/list_komitmen") }}',
    ...
    function load_data_timbangan_semua(from_date = '', to_date = '')
     {
      table = $('#complaint_timbangan_semua_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
     ...
     function load_data_timbangan_semua_admin(from_date = '', to_date = '')
     {
      table = $('#complaint_timbangan_semua_admin_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/timbangan/semua_admin") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_timbangan_proses(from_date = '', to_date = '')
     {
      table = $('#complaint_timbangan_proses_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/timbangan/proses") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_timbangan_diproses(from_date = '', to_date = '')
     {
      table = $('#complaint_timbangan_diproses_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/timbangan/diproses") }}',
        data:{from_date:from_date, to_date:to_date},
        error: function(jqXHR, ajaxOptions, thrownError) {
          alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
        }
     ...
     function load_data_timbangan_valid(from_date = '', to_date = '')
     {
      table = $('#complaint_timbangan_valid_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/timbangan/valid") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_timbangan_selesai(from_date = '', to_date = '')
     {
      table = $('#complaint_timbangan_selesai_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/timbangan/selesai") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
    ...
    $('#filter').click(function(){
      ...
      if(from_date != '' &&  to_date != '')
      {
        if(tipe_user == 1){
          $('#complaint_timbangan_semua_admin_table').DataTable().destroy();
          load_data_timbangan_semua_admin(from_date, to_date);
        }else{
          $('#complaint_timbangan_semua_table').DataTable().destroy();
          load_data_timbangan_semua(from_date, to_date);
        }
        if(target == '#semua_timbangan'){
          $('#complaint_timbangan_semua_table').DataTable().destroy();
          load_data_timbangan_semua(from_date, to_date);
          ...
          $('#complaint_timbangan_proses_table').DataTable().destroy();
          load_data_timbangan_proses(from_date, to_date);
        }else if(target == '#diproses_timbangan'){
          $('#complaint_timbangan_diproses_table').DataTable().destroy();
          load_data_timbangan_diproses(from_date, to_date);
        }else if(target == '#valid_timbangan'){
          $('#complaint_timbangan_valid_table').DataTable().destroy();
          load_data_timbangan_valid(from_date, to_date);
        }else if(target == '#selesai_timbangan'){
          $('#complaint_timbangan_selesai_table').DataTable().destroy();
          load_data_timbangan_selesai(from_date, to_date);
        }
      }
      else
      {
...
<script type="text/javascript">
  $(function () {
    ...
    $('#selesai_tanggal_komitmen_timbang').flatpickr({
      allowInput: true,
      disableMobile: true
    });

    $('#edit_selesai_tanggal_komitmen_timbang').flatpickr({
      allowInput: true,
      disableMobile: true
    });
...
<script type="text/javascript">
  $(document).ready(function(event){
    ...
    function load_data_komitmen(no_complaint = '')
      ...
      function load_komitmen_timbang(no_complaint = '')
      {
        table = $('#list_komitmen_timbang_table').DataTable({
         processing: true,
         serverSide: true,
         language: {
         ...
         ajax: {
          url:'{{ url("list_komitmen_temp/timbangan") }}',
          data:{no_complaint:no_complaint},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
      ...
      function load_edit_komitmen_timbang(no_complaint = '')
      {
        table = $('#edit_list_komitmen_timbang_table').DataTable({
         processing: true,
         serverSide: true,
         language: {
            emptyTable: "Tambahkan Data Komitmen"
         ...
         ajax: {
          url:'{{ url("edit_list_komitmen_timbangan") }}',
          data:{no_complaint:no_complaint},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
    ...
    $('body').on('click', '#proses_complaint_timbangan', function () {
      ...
      $.get(url, function (data) {
        ...
        if(data.area == '' || data.area == null){
          ...
          $('#area_timbang').val(data.area).trigger('change');
        }
        ...
        $('#supervisor_timbang').val(data.supervisor);
      ...
      if(divisi == 1){
        $('#timbanganform input[type="text"]'). prop("disabled", true);
        $('#timbanganform input[type="file"]'). prop("disabled", true);
        $('#timbanganform textarea'). prop("disabled", true);
        $('#btn_save_timbang').hide();
        $('#btn_tidak_terlibat_timbang').hide();
        $('#btn_terlibat_timbang').show();
      }else{
        $('#timbanganform input[type="text"]'). prop("disabled", false);
        $('#timbanganform input[type="file"]'). prop("disabled", false);
        $('#timbanganform textarea'). prop("disabled", false);
        $('#btn_save_timbang').show();
        $('#btn_tidak_terlibat_timbang').show();
        $('#btn_terlibat_timbang').hide();
      }
    });

    $('body').on('click', '#save_input_komitmen_timbang', function () {
      var selesai_tanggal_komitmen = $('#selesai_tanggal_komitmen_timbang').val();
      var komitmen = $('#komitmen_timabng').val();
      var nomor_complaint = $('#nomor_complaint_timbang').val();

      $.ajax({
        type: "GET",
        url: "{{ url('save_data_komitmen_timbang') }}",
        data: { 'selesai_tanggal_komitmen' : selesai_tanggal_komitmen, 'komitmen' : komitmen, 'nomor_complaint' : nomor_complaint },
        success: function (data) {
          $('#selesai_tanggal_komitmen_timbang').val('');
          $('#komitmen_timbang').val('');
          var oTable = $('#list_komitmen_timbang_table').dataTable();
          oTable.fnDraw(false);
        },
        error: function (data) {  
          var oTable = $('#list_komitmen_timbang_table').dataTable();
    ...
    $('body').on('click', '#btn_tidak_terlibat_timbang', function () {
      var complaint = $('#nomor_complaint_timbang').val();
      $('#nomor_complaint_alasan').val(complaint);
    });

    $('body').on('click', '#btn_terlibat_timbang', function () {
      var complaint = $('#nomor_complaint_timbang').val();
      var custid = $('#custid_timbang').val();
      var divisi = $('#no_divisi_timbang').val();

      if(confirm("Apakah Anda Yakin?")){
        $.ajax({
          type: "GET",
          url: "{{ url('complaint_timbangan/terlibat/') }}",
          data: { 'nomor_complaint' : complaint, 'divisi' : divisi },
          success: function (data) {
            var oTablea = $('#complaint_timbangan_semua_table').dataTable();
            oTablea.fnDraw(false);
            var oTableb = $('#complaint_timbangan_proses_table').dataTable();
            oTableb.fnDraw(false);
            var oTablec = $('#complaint_timbangan_valid_table').dataTable();
            oTablec.fnDraw(false);
            var oTabled = $('#complaint_timbangan_selesai_table').dataTable();
            oTabled.fnDraw(false);
            var oTablee = $('#complaint_timbangan_semua_admin_table').dataTable();
            oTablee.fnDraw(false);
            var oTablef = $('#complaint_timbangan_diproses_table').dataTable();
            oTablef.fnDraw(false);
            $("#modal_proses_complaint_timbangan").modal('hide');
            $("#modal_proses_complaint_timbangan").trigger('click');
    ...
    $('body').on('click', '#edit_complaint_timbangan', function () {
      var complaint = $(this).data('id');
      var custid_timbang = $(this).data('custid');
      $('#edit_nomor_complaint_timbang').val(complaint);
      $('#edit_custid_timbang').val(custid_timbang);
      var url = "{{ url('complaint_timbangan/show/edit/no_complaint') }}";
      url = url.replace('no_complaint', enc(complaint.toString()));
      $('#edit_upload_file_timbang').html('');
      $('#edit_evaluasi_timbang').html('');
      $('#edit_solusi_customer_timbang').html('');
      $('#edit_solusi_internal_timbang').html('');
      $('#edit_komitmen_timbang').html('');
      $('#edit_selesai_tanggal_komitmen_timbang').html('');
      $.get(url, function (data) {
        $('#edit_evaluasi_timbang').html(data.evaluasi);
        $('#edit_solusi_customer_timbang').html(data.solusi_customer);
        $('#edit_solusi_internal_timbang').html(data.solusi_internal);
        $('#edit_list_komitmen_timbang_table').DataTable().destroy();
        load_edit_komitmen_timbang(complaint);
        if(data.lampiran == null){
          $('#lihat_lampiran_timbang').html('No Lampiran');
          $('#lihat_lampiran_timbang').addClass('disabled');
          $('#lihat_lampiran_timbang').attr('href', '#');
        }else{
          $('#lihat_lampiran_timbang').html('Lihat Lampiran');
          $('#lihat_lampiran_timbang').removeClass('disabled');
          $('#lihat_lampiran_timbang').attr('href', '../data_file/' + data.lampiran);
        }
      })
    });

    $('body').on('click', '#save_new_edit_komitmen_timbang', function () {
      var selesai_tanggal_komitmen = $('#edit_selesai_tanggal_komitmen_timbang').val();
      var komitmen = $('#edit_komitmen_timbang').val();
      var nomor_complaint = $('#edit_nomor_complaint_timbang').val();

      $.ajax({
        type: "GET",
        url: "{{ url('save_new_edit_komitmen_timbang') }}",
        data: { 'selesai_tanggal_komitmen' : selesai_tanggal_komitmen, 'komitmen' : komitmen, 'nomor_complaint' : nomor_complaint },
        success: function (data) {
          $('#edit_selesai_tanggal_komitmen_timbang').val('');
          $('#edit_komitmen_timbang').val('');
          var oTable = $('#edit_list_komitmen_timbang_table').dataTable();
          oTable.fnDraw(false);
        },
        error: function (data) {  
          var oTable = $('#edit_list_komitmen_timbang_table').dataTable();
    ...
    $('body').on('click', '#edit-komitmen', function () {
      ...
      $('#edit_komitmen_timbang').val('');
      $('#edit_selesai_tanggal_komitmen_timbang').val('');
      $('#edit_komitmen_lama_timbang').val('');
      $('#edit_selesai_tanggal_komitmen_lama_timbang').val('');
      $('#save_edit_komitmen_timbang').show();
      $('#save_new_edit_komitmen_timbang').hide();
      $.get(url, function (data) {
        $('#edit_selesai_tanggal_komitmen_timbang').val(data.selesai_tanggal_komitmen);
        $('#edit_komitmen_timbang').val(data.komitmen);
        $('#edit_selesai_tanggal_komitmen_lama_timbang').val(data.selesai_tanggal_komitmen);
        $('#edit_komitmen_lama_timbang').val(data.komitmen);
      })
    });

    $('body').on('click', '#save_edit_komitmen_timbang', function () {
      var selesai_tanggal_komitmen = $('#edit_selesai_tanggal_komitmen_timbang').val();
      var komitmen = $('#edit_komitmen_timbang').val();
      var selesai_tanggal_komitmen_lama = $('#edit_selesai_tanggal_komitmen_lama_timbang').val();
      var komitmen_lama = $('#edit_komitmen_lama_timbang').val();
      var nomor_complaint = $('#edit_nomor_complaint_timbang').val();
      $.ajax({
        type: "GET",
        url: "{{ url('update_edit_komitmen_timbang') }}",
        ...
        success: function (data) {
          ...
          $('#edit_komitmen_lama_timbang').val('');
          $('#edit_selesai_tanggal_komitmen_lama_timbang').val('');
          $('#save_edit_komitmen_timbang').hide();
          $('#save_new_edit_komitmen_timbang').show();
          var oTable = $('#edit_list_komitmen_timbang_table').dataTable();
          oTable.fnDraw(false);
        },
        error: function (data) {
    ...
    $('body').on('click', '#validate_complaint_timbangan', function () {
      var nomor_complaint = $(this).data("id");
    ...
    $('body').on('click', '#validate_complaint', function () {
      ...
      if(confirm("Data Ini Akan Diubah Status Menjadi Done?")){
        $.ajax({
          ...
          data: { 'nomor_complaint' : nomor_complaint },
          success: function (data) {
            var oTableaa = $('#complaint_timbangan_semua_table').dataTable();
            oTableaa.fnDraw(false);
            var oTablebb = $('#complaint_timbangan_proses_table').dataTable();
            oTablebb.fnDraw(false);
            var oTablecc = $('#complaint_timbangan_valid_table').dataTable();
            oTablecc.fnDraw(false);
            var oTabledd = $('#complaint_timbangan_selesai_table').dataTable();
            oTabledd.fnDraw(false);
            var oTableee = $('#complaint_timbangan_semua_admin_table').dataTable();
            oTableee.fnDraw(false);
            var oTableff = $('#complaint_timbangan_diproses_table').dataTable();
  ...
  $(document).ready(function () {
    $('#alasantidakterlibatform').validate({
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          type:'POST',
          url: "{{ url('complaint_timbangan/tidak_terlibat') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success: function (data) {
    ...
    $('#timbanganform').validate({
      rules: {
        nomor_complaint_timbang: {
          required: true,
        },
        custid_timbang: {
          required: true,
        },
        solusi_internal_timbang: {
          required: true,
        },
        upload_file_timbang: {
      ...
      submitHandler: function(form) {
        var myform = document.getElementById("timbanganform");
        var formdata = new FormData(myform);

        $.ajax({
          type:'POST',
          url:"{{ url('/complaint_timbangan/store') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success:function(data){
            $('#timbanganform').trigger("reset");
            var oTablea = $('#complaint_timbangan_semua_table').dataTable();
            oTablea.fnDraw(false);
            var oTableb = $('#complaint_timbangan_proses_table').dataTable();
            oTableb.fnDraw(false);
    ...
    $('#edittimbanganform').validate({
      rules: {
        edit_nomor_complaint_timbang: {
          required: true,
        },
        edit_custid_timbang: {
          required: true,
        },
        edit_solusi_internal_timbang: {
          required: true,
        },
        edit_upload_file_timbang: {
          extension: "jpg,jpeg,pdf",
          filesize: 2,
        },
      },
      ...
      submitHandler: function(form) {
        var myform = document.getElementById("edittimbanganform");
        var formdata = new FormData(myform);

        $.ajax({
          type:'POST',
          url:"{{ url('/complaint_timbangan/edit') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success:function(data){
            $('#edittimbanganform').trigger("reset");
            var oTablea = $('#complaint_timbangan_semua_table').dataTable();
            oTablea.fnDraw(false);
            var oTableb = $('#complaint_timbangan_proses_table').dataTable();
            oTableb.fnDraw(false);
            ...
            var oTablee = $('#complaint_timbangan_semua_admin_table').dataTable();
            oTablee.fnDraw(false);
            $("#modal_edit_complaint_timbangan").modal('hide');
            $("#modal_edit_complaint_timbangan").trigger('click');
            alert("Data Successfully Stored");
          },
          error: function (data) {
            console.timbang('Error:', data);
            $('#edittimbanganform').trigger("reset");
            var oTablea = $('#complaint_timbangan_semua_table').dataTable();
            oTablea.fnDraw(false);
            var oTableb = $('#complaint_timbangan_proses_table').dataTable();
