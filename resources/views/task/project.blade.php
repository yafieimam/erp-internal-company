      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            @elseif(Session::get('tipe_user') == 3)
            <li class="breadcrumb-item">Produksi</li>
            @elseif(Session::get('tipe_user') == 5)
            ...
            @elseif(Session::get('tipe_user') == 16)
            <li class="breadcrumb-item">Teknik</li>
            @elseif(Session::get('tipe_user') == 18)
            <li class="breadcrumb-item">Raw Material</li>
            @elseif(Session::get('tipe_user') == 19)
            <li class="breadcrumb-item">Personal Assistant</li>
            @else
            <li class="breadcrumb-item">Produksi</li>
            @endif
...
<script type="text/javascript">
  ...
  function load_data_project(){
    $('#data-project').html("");
    var url = "{{ url('produksi/project/get/project') }}"; 
    $.get(url, function (data) {
      ...
      $.each(data, function(k, v) {
        ...
        $('#data-project').append(
          ...
          '<a href='+ 'project/board/' + v.id+' target="_blank" class="small-box bg-info" style="padding-bottom: 5%;">'+
          '<div class="inner">'+
          '<h5>' + v.title + '</h5>'+
          '</div>'+
          '</a>'+
  ...
  $('#add_project_form').validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type:'POST',
        url:"{{ url('produksi/project/create/project') }}",
        data: formdata,
        processData: false,
        contentType: false,
