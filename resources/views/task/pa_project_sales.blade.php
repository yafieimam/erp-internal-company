...
@section('title')
<title>PROJECT SALES - PT. DWI SELO GIRI MAS</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Project Sales</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
<script type="text/javascript">
  ...
  function load_data_project(){
    $('#data-project').html("");
    var url = "{{ url('pa/project/sales/get/project') }}"; 
    $.get(url, function (data) {
      $.each(data, function(k, v) {
        var tes_url = 
        $('#data-project').append(
          '<div class="col-lg-3 col-12">'+
          '<a href='+ 'sales/board/' + v.id+' target="_blank" class="small-box bg-info" style="padding-bottom: 5%;">'+
          '<div class="inner">'+
          '<h5>' + v.title + '</h5>'+
          '</div>'+
          '</a>'+
  ...
  $('#add_project_form').validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type:'POST',
        url:"{{ url('pa/project/sales/create/project') }}",
        data: formdata,
        processData: false,
        contentType: false,
