...
@section('title')
<title>FORM PESANAN - PT. DWI SELO GIRI MAS</title>
@endsection
...
@section('nav')
            <div class="bahasa">
                <p>
                  <a href="{{ url('en/orders') }}"><span class="">EN</span></a>
                  &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                  <a href="{{ url('id/orders') }}"><span class="active">IN</span></a>
                </p>
            </div>
@endsection
...
<section>
    <div class="container">
      <span class="login100-form-title wow fadeInDown">Form Pesanan</span>
      <div class="row">
        <div class="col-sm-12 padding-right">
            ...
            <div class="col-sm-6">
              <div class="view-product">
                <div class="product-information" style="padding-bottom: 74px;"><!--/product-information-->
                  <h2>Pelanggan Yang Memesan</h2>
                  <hr>
                  <h2>{{ $customer->custname }}</h2>
                  <p><b>Telepon:</b> {{ $customer->phone }}</p>
                  <p align="justify"><b>Alamat:</b> {{ $customer->address }}</p>
                  <p><b>Kota:</b> {{ $customer->name_city }}</p>
                  <p><b>NPWP:</b> {{ $customer->npwp }}</p>
                  @if($customer->crd == 1)
                  <p><b>Kredit Pembayaran:</b> {{ $customer->crd }} Hari Tunai / Transfer</p>
                  @else
                  <p><b>Kredit Pembayaran:</b> {{ $customer->crd }} Hari</p>
                  @endif
            ...
            <div class="col-sm-6">
              <div class="view-product">
                <div class="product-information"><!--/product-information-->
                  ...
                  <h2>Pelanggan Yang Menerima</h2>
                  <hr>
                  <p id="input_several_address"></p>
                  <div id="div_view_address_several"></div>
                  <div id="div_view_address">
                    <h2>{{ Session::get('name_receive') }}</h2>
                    <p><b>Telepon:</b> {{ Session::get('phone_receive') }}</p>
                    <p align="justify"><b>Alamat:</b> {{ Session::get('address_receive') }}</p>
                    <p><b>Kota:</b> {{ Session::get('name_city_receive') }}</p>
                  </div>
                  ...
                  <a href="#" id="btn_cancel_more_delivery_date" class="btn btn-danger cart checkout float-right" style="margin: 20px 10px 0 0; color:#fff; display: none;">
                    Batalkan Beberapa Tanggal Kirim
                  </a>
                </div><!--/product-information-->
              </div>
            </div>
              ...
              <div class="view-product">
                <div class="product-information"><!--/product-information-->
                  <div class="col-sm-6" id="div_delivery_date">
                    <div class="form-group validate-input" data-validate = "Tanggal Kirim Harus Diisi">
                      <label for="tanggal_kirim" class="required">Tanggal Kirim</label>
                      <input class="form-control" type="text" name="tanggal_kirim" id="tanggal_kirim" placeholder="Tanggal" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-start-date="0d" autocomplete="off" data-date-autoclose="true"/>
                    </div>
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="product-information"><!--/product-information-->
                  <div class="row">
                      ...
                      <div class="form-group">
                        <div class="form-select">
                          <div class="label-flex">
                            <label for="products" class="required">Ke Alamat?</label>
                          </div>
                          <div style="margin-bottom: 0px;">
                            <select class="dropdown-baru" name="select_address_products" id="select_address_products">
                              ...
                              <?php $i++; ?>
                              @if ($loop->first)
                              <option class="tipeName" value="{{ $alamat->id_alamat_receive }}" selected> Alamat {{ $i }} </option>
                              @else
                              <option class="tipeName" value="{{ $alamat->id_alamat_receive }}"> Alamat {{ $i }} </option>
                              @endif
                              @endforeach
                            </select>
                          </div>
                    ...
                    <div class="col-sm-6" id="div_delivery_date_products" style="display: none;">
                      <div class="form-group">
                        <label for="tanggal_kirim" class="required">Tanggal Kirim</label>
                        <input class="form-control" type="text" name="tanggal_kirim_products" id="tanggal_kirim_products" placeholder="Tanggal Kirim" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-start-date="0d" autocomplete="off" data-date-autoclose="true"/>
                      </div>
                    </div>
                  </div>
                  <?php
                  ...
                  <div id="div-exist-products">
                    <div class="col-sm-5">
                      ...
                      <div class="form-group">
                        <div class="form-select">
                          <div class="label-flex">
                            <label for="products" class="required">ProduK</label>
                          </div>
                          <div style="margin-bottom: 0px;">
                            <select class="dropdown-baru" name="products" id="products">
                              <option class="tipeName" value="">ProduK</option>
                  ...
                  <div id="div-exist-qty">
                    <div class="col-sm-3">
                      <div class="form-group">
                        <div class="form-select">
                          <div class="label-flex">
                            <label for="quantity" class="required">Jumlah (KG)</label>
                          </div>
                          <div style="margin-bottom: 0px;">
                            <select class="dropdown-baru" name="quantity" id="quantity">
                              <option class="tipeName" value="">Jumlah (KG)</option>
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        ...
                        <input class="btn btn-success" type="submit" name="btn-products" id="btn-products" value="Tambah" style="margin-top: 5px;"/>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label for="btn-products"></label>
                        <input class="btn btn-primary" type="button" name="btn-new-products" id="btn-new-products" value="Produk Baru" style="margin-top: 5px;"/>
                      </div>
                    </div>
                  </div>
                  <?php
                  ...
                  <div class="col-sm-5">
                    <div class="form-group">
                      <label for="quantity" class="required">Jumlah (KG)</label>
                      <input class="form-control" type="text" name="quantity" id="quantity" placeholder="Jumlah (KG)" />
                      <span class="show_saldo" id="show_saldo"></span>
                    </div>
                  </div>
                  <div class="col-sm-2">
                    <div class="form-group">
                      <label for="btn-products"></label>
                      <input class="btn btn-primary" type="submit" name="btn-products" id="btn-products" value="Tambah" style="margin-top: 5px;"/>
                    </div>
                  </div>
                  <?php
                  }
                    ...
                    <form id="newproductsform" name="newproductsform" method="post" action="javascript:void(0)">
                      <div class="col-sm-5">
                        ...
                        <div class="form-group">
                          <div class="form-select">
                            <div class="label-flex">
                              <label for="new_products" class="required">Produk</label>
                            </div>
                            <div style="margin-bottom: 0px;">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          <label for="new_quantity" class="required">Jumlah (KG)</label>
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <input class="btn btn-success" type="submit" name="new-btn-products" id="new-btn-products" value="Tambah" style="margin-top: 5px;"/>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="form-group">
                          <label for="new-btn-products"></label>
                          <input class="btn btn-danger" type="button" name="cancel-btn-products" id="cancel-btn-products" value="Batal" style="margin-top: 5px;"/>
                        </div>
                      </div>
                    </form>
                  </div>
            ...
            <div class="col-sm-12">
              <div class="view-product">
                <div class="product-information"><!--/product-information-->
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="keterangan_order">Keterangan Lain</label>
                      <textarea class="form-control" rows="3" name="keterangan_order" id="keterangan_order" placeholder="Keterangan Lain"></textarea>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="product-details"><!--product-details-->
            ...
            <div class="col-sm-4 div-btn-orders">
              <input class="btn btn-success" type="button" name="btn-orders" id="btn-orders" value="Pesan" style="margin-top: 5px; height: 40px;"/>
              <input class="btn btn-success" type="button" name="btn-several-orders" id="btn-several-orders" value="Pesan" style="margin-top: 5px; height: 40px;"/>
              <input class="btn btn-success" type="button" name="btn-delivdate-orders" id="btn-delivdate-orders" value="Pesan" style="margin-top: 5px; height: 40px; display: none;"/>
            </div>
            <div class="col-sm-4"></div>
          </div>
        </div>
...
<!-- </form> -->
    ...
    <div class="modal-dialog" style="width: 500px;">
      <div class="modal-content">
        <div class="modal-header">
          <span class="login100-form-title-popup">Tambah Alamat Baru</span>
        ...
        <div class="modal-body">
          ...
          <form id="addressform" name="addressform" method="post" action="javascript:void(0)">
            {{ csrf_field() }}
            <div class="form-group validate-input" data-validate = "Nama Harus Diisi">
              <label for="name" class="required">Nama</label>
              <input class="form-control" type="text" name="name_receive" id="name_receive" placeholder="Nama" />
            </div>
            <div class="form-group validate-input" data-validate = "Alamat Harus Diisi">
              <label for="address" class="required">Alamat</label>
              <textarea class="form-control" rows="3" name="address_receive" id="address_receive" placeholder="Alamat"></textarea>
            </div>
            <div class="form-select validate-input" data-validate = "Kota Harus Diisi">
              <div class="label-flex">
            ...
            <div class="form-group validate-input" data-validate = "Telepon Harus Diisi">
              <label for="phone" class="required">Telepon</label>
              <input class="form-control" type="text" name="phone_receive" id="phone_receive" placeholder="Telepon" />
            </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger btn-default pull-left" data-dismiss="modal"><i class="fa fa-remove"></i> Batal</button>
        </div>
      </div>
  ...
  <div class="modal fade" id="modal_history_address">
    <div class="modal-dialog" style="width: 600px;">
      <div class="modal-content">
        <div class="modal-header">
          <span class="login100-form-title-popup">Pilih Alamat Lain</span>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
          <button type="button" data-dismiss="modal" data-toggle="modal" data-target="#modal_choose_address" class="btn btn-outline-secondary btn-lg btn-block" style="border: 2px dashed #868e96;">Tambah Alamat Baru</button>
  ...
  <div class="modal fade" id="modal_several_address">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Kirim ke Beberapa Alamat</h4>
  ...
  $(document).ready(function(){
    ...
    if(select_produk != null || select_produk != ''){
      ...
      $.get(url_saldo, function (data_saldo) {
        $('#show_saldo').html('Saldo Tersisa : ' + (data_saldo.saldo).toLocaleString('id-ID') + ' KG');
      })
    }
    ...
    if(several == 1){
      ...
      $('#input_several_address').html('<h2>Pesanan Diantar Ke Lebih Dari 1 Alamat</h2>');
      $('#products_several_table').DataTable().destroy();
      $('#products_several_table').DataTable({
        processing: true,
        serverSide: true,
        language: {
          emptyTable: "Tambahkan Produk Yang Ingin Dibeli"
        },
        ajax: {
    ...
    $("#new_products").change(function() {
      ...
      url_saldo = url_saldo.replace('kode_produk', enc(select_produk));
      $.get(url_saldo, function (data_saldo) {
        $('#new_show_saldo').html('Saldo Tersisa : ' + (data_saldo.saldo).toLocaleString('id-ID') + ' KG');
      })
    });
    ...
    $('body').on('click', '#btn-orders', function () {
      ...
      if (count == 0)
      {
        alert("Tolong tambahkan produk yang ingin dibeli");
      }else{
        if((tanggal_kirim == null || tanggal_kirim == "")){
          ...
          $.ajax({
            ...
            success:function(data){
              ...
              window.location = "{{ url('/id/orders/list') }}";
            },
            error: function (data) {
    ...
    $(document).on('show.bs.modal', '#modal_history_address', function (e) {
      ...
      $('#div-address-list').load('/list/id/address?page=1');
    });
    ...
    $(document).on('show.bs.modal', '#modal_several_address', function (e) {
      ...
      $('#div-address-list-several').load('/list/id/address/several?page=1');
    });
