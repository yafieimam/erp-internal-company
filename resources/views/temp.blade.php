...
@section('title')
<title>LIHAT COMPLAINT PRODUKSI - PT. DWI SELO GIRI MAS</title>
@endsection
...
@section('content')
<div class="container">
  <div class="title-view"><h2>View Complaint Produksi</h2></div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="margin-top: 300px;">
        <div class="modal-header">
          <span class="login100-form-title-popup judul">Form Complaint</span>
          <span class="login100-form-title-popup judulpr" style="display: none;">Form Complaint Produksi</span>
          <span class="login100-form-title-popup judullg" style="display: none;">Form Complaint Logistik</span>
          <span class="login100-form-title-popup judulln" style="display: none;">Form Complaint Lainnya</span>
        ...
        <div class="modal-body">
          ...
          @endif
          <form id="complaintform" name="complaintform" method="post" enctype="multipart/form-data" action="javascript:void(0)">
            ...
            <div class="form-group validate-input" data-validate = "Divisi Complaint is required">
              ...
              <select class="dropdown-baru" name="divisi_complaint" id="divisi_complaint">
                ...
                <option class="tipeArea prd" value="1">Produksi</option>
                <option class="tipeArea lgs" value="2">Logistik</option>
                <option class="tipeArea lny" value="3">Lainnya</option>
              </select>
            </div>
            <div id="form-complaint-produksi" style="display: none;">
            <div class="form-row">
            <div class="form-group validate-input" data-validate = "Tanggal is required">
              ...
              <input class="form-control" type="text" name="tanggal_produksi" id="tanggal_produksi" placeholder="Tanggal" data-date-format="YYYY-MM-DD" readonly/>
            </div>
            <div class="form-group validate-input" data-validate = "No Lot is required">
              <label for="no_lot" class="required">No Lot</label>
              <input class="form-control" type="text" name="no_lot" id="no_lot" placeholder="No Lot" />
            </div>
            </div>
            <div class="form-row">
            <div class="form-group validate-input" data-validate = "Mesin is required">
              <label for="mesin" class="required">Mesin</label>
            ...
            <div class="form-group validate-input" data-validate = "Area is required">
              ...
              <select class="dropdown-baru" name="area" id="area">
            ...
            <div class="form-group validate-input" data-validate = "Supervisor is required">
              ...
              <input class="form-control" type="text" name="supervisor" id="supervisor" placeholder="Supervisor" />
            </div>
            ...
            <input type="submit" class="btn btn-success btn-block" id="submit-produksi" placeholder="Submit">
...
@section('script_login')
      ...
      $('body').on('click', '#proses-complaint', function () {
        ...
        $("#divisi_complaint").change(function() {
          if ($(this).val() == 1) {
            ...
            $('.judullg').hide();
            $('.judulln').hide();
            // $('#complaintform').attr('id','produksiform');
            $('#form-complaint-produksi').show();
            ...
            $('.judullg').show();
            $('.judulln').hide();
            // $('#complaintform').attr('id','logistikform');
            $('#form-complaint-produksi').hide();
            ...
            $('.judullg').hide();
            $('.judulln').show();
            // $('#complaintform').attr('id','lainnyaform');
            $('#form-complaint-produksi').hide();
            $('#form-complaint-logistik').hide();
  ...
  <script type="text/javascript">
    ...
    //       $('.judul').show();
    //       $('.judulpr').hide();
    //       $('#logistikform').attr('id','complaintform');
    //       $('#form-complaint-logistik').hide();
    ...
    if ($("#produksiform").length > 0) {
      $("#produksiform").validate({
        ...
        messages: {
          ...
          tanggal_produksi: {
            required: "Tanggal Produksi is required",
          },  
          no_lot: {
            required: "No Lot is required",
          },  
          mesin: {
            required: "Mesin is required",
          },  
          area: {
            required: "Area is required",
          },  
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          $('#tanggal_produksi').datepicker().datepicker("setDate",'now');
          $('.judul').show();
          $('.judulpr').hide();
          // $('#produksiform').attr('id','complaintform');
          $('#form-complaint-produksi').hide();
          $('#form-complaint').modal('hide');
          var oTable = $('#complaint_table').dataTable();
          oTable.fnDraw(false);
