...
<!-- Modal -->
  <div class="modal fade" tabindex="-1" id="modal_process_complaint_produksi" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="margin-top: 300px;">
        <div class="modal-header">
          <span class="login100-form-title-popup">Form Complaint Produksi</span>
        ...
        <div class="modal-body">
          ...
          @endif
          <form id="produksiform" name="produksiform" method="post" enctype="multipart/form-data" action="javascript:void(0)">
...
<script type="text/javascript">
    var baseurl = "{{ url('/view_complaint_produksi') }}";
