...
<div class="col-sm-12 border list-address" style="padding: 0; margin-top: 20px">
  <div class="list-products" style="padding: 10px 15px 10px 15px;">
    ...
    ?>
      ...
      <a class="btn btn-danger float-right" href="#" data-id="{{ $data_address->id_alamat_receive }}" id="btn-cancel-address" style="margin-bottom: 10px; margin-top: 16px; border: 0 none; margin-right: 10px;">Batal <i class="fa fa-arrow-circle-right"></i></a>
    <?php
    }else{
    ?>
