                                    ...
                                    <td style="margin:0;padding:0">
                                        ...
                                        <div style="margin:0 0 20px;padding:0">
                                            <table bgcolor="transparent" style="width:100%;max-width:100%;border-collapse:collapse;border-spacing:0;background-color:transparent;margin:5px 0;padding:0">
                                                <tbody style="margin:0;padding:0">
                                                    <tr style="margin:0;padding:0">
                                                        ...
                                                        <td valign="top" style="font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0">{{ $nama }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table bgcolor="transparent" style="width:100%;max-width:100%;border-collapse:collapse;border-spacing:0;background-color:transparent;margin:5px 0;padding:0">
                                                <tbody style="margin:0;padding:0">
                                                    <tr style="margin:0;padding:0">
                                                        ...
                                                        <td valign="top" style="font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0"><a href="mailto:{{ $email }}">{{ $email }}</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table bgcolor="transparent" style="width:100%;max-width:100%;border-collapse:collapse;border-spacing:0;background-color:transparent;margin:5px 0;padding:0">
                                                <tbody style="margin:0;padding:0">
                                                    <tr style="margin:0;padding:0">
                                                        <td valign="top" style="width:25%;font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0">Position:
                                                        </td>
                                                        <td valign="top" style="font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0">{{ $position }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table bgcolor="transparent" style="width:100%;max-width:100%;border-collapse:collapse;border-spacing:0;background-color:transparent;margin:5px 0;padding:0">
                                                <tbody style="margin:0;padding:0">
                                                    <tr style="margin:0;padding:0">
                                                        ...
                                                        <td valign="top" style="font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0">{{ $phone }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tr style="margin:0;padding:0">
                                    <td valign="top" style="margin:0;padding:0 10px 0 0;width:75%">
                                        ...
                                        <span style="font-size:12px;margin-bottom:6px;display:inline-block">
                                            <b>Hubungi <span class="lG">PT. Dwi Selo Giri Mas</span></b> <br>
                                            Phone: 0819 7324 1373 <br>
                                            Email: <a href="mailto:sales@dwiselogirimas.com">sales@dwiselogirimas.com</a> <br>
                                        </span> 
                                        <?php /*
                                    ...
                                    <td valign="top" style="margin:0;padding:0">
                                        ...
                                        <span style="font-size:12px;margin-bottom:6px;display:inline-block">Kunjungi Kami</span>

                                        <div style="text-align:left">
                                            <a target="_blank" style="color:#008000;display:inline-block;text-decoration: none;" href="{{ url('/') }}"><img style="border:0;min-height:auto;max-width:15px;outline:0;" alt="Website" src="{{asset('app-assets/images/icons/icon_web.png')}}"> Website</a>
                                ...
                                <tr style="margin:0;padding:0">
                                    ...
                                    */ ?>
                                    <td valign="middle" style="margin:0;padding:0;width:53%">
                                        ...
                                        <p style="color:#91908e;font-size:10px;line-height:150%;font-weight:normal;margin:0px;padding:0px">Jika butuh bantuan, gunakan halaman <a target="_blank" style="color:#0f990f;text-decoration:none;margin:0;padding:0" href="{{ url('en/contact') }}">Kontak Kami</a>.<br style="margin:0;padding:0"><?php echo date('Y') ?> &copy;

                                            <span class="lG">PT. Dwi Selo Giri Mas</span></p>
                                    </td>
                                    <td valign="middle" style="width:40%"> 

                                        <div style="text-align:right"><img alt="PT. Dwi Selo Giri Mas" style="max-width: 140px;" src="{{asset('app-assets/asset/images/logo-header-sticky.png')}}">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
