...
@section('title')
<title>KIRIM PENERIMAAN BG - PT. DWI SELO GIRI MAS</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Kirim Penerimaan BG</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ url('/homepage') }}">Home</a></li>
            <li class="breadcrumb-item">Admin DSGM</li>
            <li class="breadcrumb-item">Kirim Penerimaan BG</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
      ...
      <div class="card">
        <div class="card-header">
          <ul class="nav nav-tabs nav-tabs-lihat" id="custom-content-below-tab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#kirim_data" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Kirim Data</a>
            </li>
            <li class="nav-item">
        ...
        <div class="card-body">
          <div class="tab-content" id="custom-content-below-tabContent">
            <div class="tab-pane fade show active" id="kirim_data" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div>
            <table id="detail_data_kirim_table" style="width: 100%;" class="table table-bordered table-hover responsive">
              <thead>
                <tr>
                  <th>Nomor SJ</th>
                  <th>Customer</th>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = $('#data_kirim_table').DataTable({
         ...
         ajax: {
          url:'{{ url("admin/dsgm/kirim_bg/table") }}',
    ...
    function load_data_terkirim(from_date = '', to_date = '')
    {
      table = $('#data_terkirim_table').DataTable({
        ...
        lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
        ajax: {
          url:'{{ url("admin/dsgm/terkirim_bg/table") }}',
          data:{from_date:from_date, to_date:to_date},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
        ...
        {
          data:'tanggal_kirim_cek',
          name:'tanggal_kirim_cek',
          className:'dt-center'
        },
        {
          data:'jumlah_sj',
    ...
    function load_data_kirim_detail(tanggal = '')
    {
      table = $('#detail_data_kirim_table').DataTable({
        ...
        bInfo : false,
        ajax: {
          url:'{{ url("admin/dsgm/kirim_bg/detail/table") }}',
        ...
        {
          data:'keterangan_kirim_cek',
          name:'keterangan_kirim_cek',
          className:'dt-center',
          render: function ( data, type, row)
          {
            return '<textarea rows="2" name="keterangan[' + $('<div />').text(row.nosj).html() + ']" style="width:100%;">' + $('<div />').text(row.keterangan).html() + '</textarea>';
          },
          width:'18%'
        },
        {
          data:'check_dikirim_cek',
          name:'check_dikirim_cek',
          className:'dt-center',
          render: function ( data, type, row)
          {
    ...
    $('#btn-save-data').click( function() {
      ...
      $.ajax({
        ...
        type: "POST",
        url: '{{ url("admin/dsgm/update/kirim_bg") }}',
        dataSrc : 'data',
        dataType: 'JSON',
        data: data,
        async: 'false',
