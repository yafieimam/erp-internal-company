...
<body>
    <h2>Packing List Dokumen Cek / Giro Yang Diterima Trunojoyo Tgl {{ date('j F Y', strtotime($data[0]->tanggal_terima_cek)) }}</h2>
    <?php $count = 0 ?>
    <table style="width: 100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $data->nama_metode_pembayaran }} <br> No. {{ $data->nomor_metode_pembayaran }} <br> Rp {{ number_format($data->nominal_bayar, 0, ".", ".") }}</td>
