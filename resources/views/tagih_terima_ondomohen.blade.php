      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item">Ondomohen</li>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = $('#data_terima_table').DataTable({
         ...
         ajax: {
          url:'{{ url("ondomohen/terima_ondomohen/table") }}',
    ...
    function load_data_dokumen_list(from_date = '', to_date = '')
    {
      table = $('#data_dokumen_list_table').DataTable({
        ...
        lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
        ajax: {
          url:'{{ url("ondomohen/dokumen_list/table") }}',
          data:{from_date:from_date, to_date:to_date},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
        ...
        {
          data:'tanggal_terima_ondomohen',
          name:'tanggal_terima_ondomohen',
          className:'dt-center',
          render: function ( data, type, full, meta ) {
            return moment(data).format('DD MMM YYYY');
          }
    ...
    function load_data_view(tanggal = '')
    {
      table = $('#detail_view_data_table').DataTable({
        ...
        lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
        ajax: {
          url:'{{ url("ondomohen/dokumen_list/view/table") }}',
    ...
    function load_data_terima_detail(tanggal = '')
    {
      table = $('#detail_data_terima_table').DataTable({
        ...
        bInfo : false,
        ajax: {
          url:'{{ url("ondomohen/terima_ondomohen/detail/table") }}',
          data:{tanggal:tanggal},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
        ...
        {
          data:'check_diterima_ondomohen',
          name:'check_diterima_ondomohen',
          width:'7%',
          className:'dt-center',
          render: function ( data, type, row)
          {
    ...
    $('#btn-save-data').click( function() {
      ...
      $.ajax({
        ...
        type: "POST",
        url: '{{ url("ondomohen/update/terima_ondomohen") }}',
        dataSrc : 'data',
        dataType: 'JSON',
        data: data,
        async: 'false',
