...
<style type="text/css">
  ...
  #save_input_komitmen_prd, #save_new_edit_komitmen_prd, #save_edit_komitmen_prd{
    right: 20%;
    position: absolute;
    top: 23%;
    width: 60%;
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body" id="complaint_produksi">
          <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
            ...
            ?>
            <li class="nav-item">
              <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#semua_produksi_admin" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Semua</a>
            </li>
            <?php
              }else{
            ?>
            <li class="nav-item">
              <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#semua_produksi" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Semua</a>
            </li>
            <?php
              }
            }
            ?>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#proses_produksi" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Proses</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#diproses_produksi" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Sedang Diproses</a>
            </li>
            <?php
              if(Session::get('login_admin')){
                if(Session::get('tipe_user') == 1){
            ?>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#valid_produksi" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Validasi</a>
            </li>
            <?php
              }
            }
            ?>
            <li class="nav-item">
              <a class="nav-link" id="custom-content-below-messages-tab" data-toggle="pill" href="#selesai_produksi" role="tab" aria-controls="custom-content-below-messages" aria-selected="false">Selesai</a>
            </li>
          </ul>
          <div class="tab-content" id="custom-content-below-tabContent">
            ...
            if(Session::get('login_admin')){
              if(Session::get('tipe_user') == 1){
            ?>
           <div class="tab-pane fade show active" id="semua_produksi_admin" role="tabpanel" aria-labelledby="custom-content-below-home-tab" style="margin-top: 40px;">
              <table id="complaint_produksi_semua_admin_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
           ...
           ?>
           <div class="tab-pane fade show active" id="semua_produksi" role="tabpanel" aria-labelledby="custom-content-below-home-tab" style="margin-top: 40px;">
              <table id="complaint_produksi_semua_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           ?>
           <div class="tab-pane fade" id="proses_produksi" role="tabpanel" aria-labelledby="custom-content-below-profile-tab" style="margin-top: 40px;">
             <table id="complaint_produksi_proses_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           <div class="tab-pane fade" id="diproses_produksi" role="tabpanel" aria-labelledby="custom-content-below-profile-tab" style="margin-top: 40px;">
             <table id="complaint_produksi_diproses_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           <div class="tab-pane fade" id="valid_produksi" role="tabpanel" aria-labelledby="custom-content-below-messages-tab" style="margin-top: 40px;">
             <table id="complaint_produksi_valid_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
           ...
           <div class="tab-pane fade" id="selesai_produksi" role="tabpanel" aria-labelledby="custom-content-below-messages-tab" style="margin-top: 40px;">
             <table id="complaint_produksi_selesai_table" style="width: 100%;" class="table table-bordered table-hover responsive">
                <thead>
                  <tr>
                    <th class="not-mobile">No Complaint</th>
                    <th>Tanggal</th>
...
<div class="modal fade" id="modal_konfirmasi_request_lab">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Perihal Request Ke Lab?</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" class="requestform" id="requestform" action="javascript:void(0)">
          {{ csrf_field() }}
      <div class="modal-body">
        <div class="form-group">
          <input class="form-control" type="hidden" name="nomor_complaint_req" id="nomor_complaint_req" />
        </div>
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              <label for="alasan_request_lab">Alasan Request Ke Lab</label>
              <textarea class="form-control" rows="3" name="alasan_request_lab" id="alasan_request_lab" placeholder="Alasan Request Ke Lab"></textarea>
            </div>
          </div>
        </div>
      </div>
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal" data-toggle="modal" data-target="#modal_proses_complaint_produksi">Close</button>
...
<div class="modal fade" id="modal_proses_complaint_produksi">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Proses Complaint Produksi</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" class="produksiform" id="produksiform" action="javascript:void(0)" enctype="multipart/form-data">
          {{ csrf_field() }}
      <div class="modal-body">
        <div class="form-group">
          <input class="form-control" type="hidden" name="nomor_complaint_prd" id="nomor_complaint_prd" />
        </div>
        <div class="form-group">
          <input class="form-control" type="hidden" name="custid_prd" id="custid_prd" />
        </div>
        <div class="form-group">
          <input class="form-control" type="hidden" name="no_divisi_prd" id="no_divisi_prd" />
        </div>
        ...
        <div class="row">
          <div class="col-4">
            <div class="form-group">
              <label for="evaluasi_prd">Evaluasi</label>
              <textarea class="form-control" rows="3" name="evaluasi_prd" id="evaluasi_prd" placeholder="Evaluasi"></textarea>
            </div>
          </div>
          <div class="col-4">
            <div class="form-group">
              <label for="solusi_internal_prd">Solusi Internal</label>
              <textarea class="form-control" rows="3" name="solusi_internal_prd" id="solusi_internal_prd" placeholder="Solusi Internal"></textarea>
            </div>
          </div>
          <div class="col-4">
            <div class="form-group">
              <label for="upload_file_prd">Lampiran</label>
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="upload_file_prd" name="upload_file_prd">
                  <label class="custom-file-label" for="upload_file_prd">Choose file</label>
                </div>
              </div>
            </div>
          ...
          <div class="col-6" style="display: none;">
            <div class="form-group">
              <label for="solusi_customer_prd">Solusi Customer</label>
              <textarea class="form-control" rows="5" name="solusi_customer_prd" id="solusi_customer_prd" placeholder="Solusi Customer"></textarea>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-5">
            <div class="form-group">
              <label for="komitmen_prd">Tindakan / Komitmen</label>
              <textarea class="form-control" rows="3" name="komitmen_prd" id="komitmen_prd" placeholder="Tindakan / Komitmen"></textarea>
            </div>
          </div>
          <div class="col-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="selesai_tanggal_komitmen_prd" id="selesai_tanggal_komitmen_prd" autocomplete="off" placeholder="Selesai Tanggal">
              </div>
              <!-- /.input group -->
            </div>
          </div>
          <div class="col-2">
            <div class="form-group">
              <label>&nbsp</label>
              <button type="button" class="btn btn-success" id="save_input_komitmen_prd">Save</button>
            </div>
          </div>
        </div>
        <table id="list_komitmen_prd_table" style="width: 100%;" class="table table-bordered table-hover responsive">
          <thead>
            <tr>
      ...
      <div class="modal-footer justify-content-between btn-modal-bottom">
        <button type="button" class="btn btn-default save-btn-modal-bottom" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-success save-btn-modal-bottom" id="btn_request_lab_prd" data-dismiss="modal" data-toggle="modal" data-target="#modal_konfirmasi_request_lab">Request ke Lab</button>
        <button type="button" class="btn btn-danger save-btn-modal-bottom" id="btn_no_request_lab_prd">Batalkan Request Lab</button>
        <button type="button" class="btn btn-danger save-btn-modal-bottom" id="btn_tidak_terlibat_prd" data-dismiss="modal" data-toggle="modal" data-target="#modal_alasan_tidak_terlibat">Tidak Terlibat</button>
        <button type="button" class="btn btn-success save-btn-modal-bottom" id="btn_terlibat_prd" style="display: none;">Terlibat</button>
        <button type="submit" class="btn btn-primary save-btn-modal-bottom" id="btn_save_prd">Save changes</button>
      </div>
    </form>
    </div>
    <!-- /.modal-content -->
...
<div class="modal fade" id="modal_edit_complaint_produksi">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Edit Complaint Produksi</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" class="editproduksiform" id="editproduksiform" action="javascript:void(0)" enctype="multipart/form-data">
          {{ csrf_field() }}
      <div class="modal-body">
        <div class="form-group">
          <input class="form-control" type="hidden" name="edit_nomor_complaint_prd" id="edit_nomor_complaint_prd" />
        </div>
        <div class="form-group">
          <input class="form-control" type="hidden" name="edit_custid_prd" id="edit_custid_prd" />
        </div>
        <div class="row">
          <div class="col-5">
            <div class="form-group">
              <label for="edit_upload_file_prd">Ubah Lampiran</label>
              <div class="input-group">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="edit_upload_file_prd" name="edit_upload_file_prd">
                  <label class="custom-file-label" for="upload_file_prd">Choose file</label>
                </div>
              </div>
            </div>
          ...
          <div class="col-3">
            <div class="form-group">
              ...
              <div class="custom-control custom-radio radio-control">
                <a target="_blank" id="lihat_lampiran_prd" class="btn btn-primary save-btn-in">Lihat Lampiran</a>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-6">
            <div class="form-group">
              <label for="edit_evaluasi_prd">Evaluasi</label>
              <textarea class="form-control" rows="3" name="edit_evaluasi_prd" id="edit_evaluasi_prd" placeholder="Evaluasi"></textarea>
            </div>
          </div>
          <div class="col-6">
            <div class="form-group">
              <label for="edit_solusi_internal_prd">Solusi Internal</label>
              <textarea class="form-control" rows="3" name="edit_solusi_internal_prd" id="edit_solusi_internal_prd" placeholder="Solusi Internal"></textarea>
            </div>
          </div>
        </div>
        <div class="row" id="div_edit_komitmen_prd">
          <div class="col-5">
            <div class="form-group">
              <label for="edit_komitmen_prd">Tindakan / Komitmen</label>
              <textarea class="form-control" rows="3" name="edit_komitmen_prd" id="edit_komitmen_prd" placeholder="Tindakan / Komitmen"></textarea>
            </div>
          </div>
          <div class="col-5">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="edit_selesai_tanggal_komitmen_prd" id="edit_selesai_tanggal_komitmen_prd" autocomplete="off" placeholder="Finish Date Komitmen">
              </div>
              <!-- /.input group -->
            </div>
          </div>
          <textarea class="form-control" name="edit_komitmen_lama_prd" id="edit_komitmen_lama_prd" style="display: none;"></textarea>
          <input type="hidden" class="form-control" name="edit_selesai_tanggal_komitmen_lama_prd" id="edit_selesai_tanggal_komitmen_lama_prd" autocomplete="off">
          <div class="col-2">
            <div class="form-group">
              <label>&nbsp</label>
              <button type="button" class="btn btn-success" id="save_new_edit_komitmen_prd">Save</button>
              <button type="button" class="btn btn-success" id="save_edit_komitmen_prd" style="display: none;">Edit</button>
            </div>
          </div>
        </div>
        <table id="edit_list_komitmen_prd_table" style="width: 100%;" class="table table-bordered table-hover responsive">
          <thead>
            <tr>
              <th>Tanggal Selesai</th>
              <th>Komitmen</th>
        ...
        <div class="row">
          <div class="col-6" style="display: none;">
            <div class="form-group">
              <label for="edit_solusi_customer_prd">Solusi Customer</label>
              <textarea class="form-control" rows="3" name="edit_solusi_customer_prd" id="edit_solusi_customer_prd" placeholder="Solusi Customer"></textarea>
            </div>
          </div>
        </div>
      </div>
...
<!--   <script src="{{asset('lte/plugins/datatables/jquery.dataTables.js')}}"></script>
  ...
  <script>
    $(document).ready(function(){
      ...
      var table = $('#complaint_produksi_semua_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/produksi/semua") }}',
        data : function( d ) {
          d.nomor = any_nomor;
        }
       },
      ...
      if(any_nomor != '' && type == 4){
        table.ajax.url('{{ url("complaint_produksi/specific") }}').load();
      }

      if(tipe_user == 1){
        $('#complaint_produksi_semua_admin_table').DataTable().destroy();
        load_data_produksi_semua_admin();
      }
      $('.nav-tabs a').on('shown.bs.tab', function (e) {
        target = $(e.target).attr("href");
        if(target == '#semua_produksi'){
          $('#complaint_produksi_semua_table').DataTable().destroy();
          load_data_produksi_semua();
        }else if(target == '#semua_produksi_admin'){
          $('#complaint_produksi_semua_admin_table').DataTable().destroy();
          load_data_produksi_semua_admin();
        }else if(target == '#proses_produksi'){
          $('#complaint_produksi_proses_table').DataTable().destroy();
          load_data_produksi_proses();
        }else if(target == '#diproses_produksi'){
          $('#complaint_produksi_diproses_table').DataTable().destroy();
          load_data_produksi_diproses();
        }else if(target == '#valid_produksi'){
          $('#complaint_produksi_valid_table').DataTable().destroy();
          load_data_produksi_valid();
        }else if(target == '#selesai_produksi'){
          $('#complaint_produksi_selesai_table').DataTable().destroy();
          load_data_produksi_selesai();
        }
      });
      ...
      function load_data_komitmen()
      {
        table = $('#list_komitmen_table').DataTable({
         ...
         lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
         ajax: {
          url:'{{ url("produksi_complaint/list_komitmen") }}',
    ...
    function load_data_produksi_semua(from_date = '', to_date = '')
     {
      table = $('#complaint_produksi_semua_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
     ...
     function load_data_produksi_semua_admin(from_date = '', to_date = '')
     {
      table = $('#complaint_produksi_semua_admin_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/produksi/semua_admin") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_produksi_proses(from_date = '', to_date = '')
     {
      table = $('#complaint_produksi_proses_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/produksi/proses") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_produksi_diproses(from_date = '', to_date = '')
     {
      table = $('#complaint_produksi_diproses_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/produksi/diproses") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_produksi_valid(from_date = '', to_date = '')
     {
      table = $('#complaint_produksi_valid_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/produksi/valid") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
     ...
     function load_data_produksi_selesai(from_date = '', to_date = '')
     {
      table = $('#complaint_produksi_selesai_table').DataTable({
       processing: true,
       serverSide: true,
       lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
       ajax: {
        url:'{{ url("complaint/produksi/selesai") }}',
        data:{from_date:from_date, to_date:to_date}
       },
       dom: 'lBfrtip',
       buttons: ['copy', 'csv', 'excel', 'pdf', 'print'],
    ...
    $('#filter').click(function(){
      ...
      if(from_date != '' &&  to_date != '')
      {
        if(tipe_user == 1){
          $('#complaint_produksi_semua_admin_table').DataTable().destroy();
          load_data_produksi_semua_admin(from_date, to_date);
        }else{
          $('#complaint_produksi_semua_table').DataTable().destroy();
          load_data_produksi_semua(from_date, to_date);
        }
        if(target == '#semua_produksi'){
          $('#complaint_produksi_semua_table').DataTable().destroy();
          load_data_produksi_semua(from_date, to_date);
          ...
          $('#complaint_produksi_proses_table').DataTable().destroy();
          load_data_produksi_proses(from_date, to_date);
        }else if(target == '#diproses_produksi'){
          $('#complaint_produksi_diproses_table').DataTable().destroy();
          load_data_produksi_diproses(from_date, to_date);
        }else if(target == '#valid_produksi'){
          $('#complaint_produksi_valid_table').DataTable().destroy();
          load_data_produksi_valid(from_date, to_date);
        }else if(target == '#selesai_produksi'){
          $('#complaint_produksi_selesai_table').DataTable().destroy();
          load_data_produksi_selesai(from_date, to_date);
        }
      }
      else
      {
...
<script type="text/javascript">
  $(function () {
    ...
    $('#selesai_tanggal_komitmen_prd').flatpickr({
      allowInput: true,
      disableMobile: true
    });

    $('#edit_selesai_tanggal_komitmen_prd').flatpickr({
      allowInput: true,
      disableMobile: true
    });
...
<script type="text/javascript">
  $(document).ready(function(event){
    ...
    function load_data_komitmen(no_complaint = '')
      ...
      function load_komitmen_prd(no_complaint = '')
      {
        table = $('#list_komitmen_prd_table').DataTable({
         processing: true,
         serverSide: true,
         language: {
         ...
         ajax: {
          url:'{{ url("list_komitmen_temp/produksi") }}',
          data:{no_complaint:no_complaint},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
      ...
      function load_edit_komitmen_prd(no_complaint = '')
      {
        table = $('#edit_list_komitmen_prd_table').DataTable({
         processing: true,
         serverSide: true,
         language: {
            emptyTable: "Tambahkan Data Komitmen"
         ...
         ajax: {
          url:'{{ url("edit_list_komitmen_produksi") }}',
          data:{no_complaint:no_complaint},
          error: function(jqXHR, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + jqXHR.statusText + "\r\n" + jqXHR.responseText + "\r\n" + ajaxOptions.responseText);
          }
    ...
    $('body').on('click', '#proses_complaint_produksi', function () {
      var complaint = $(this).data('id');
      var custid_prd = $(this).data('custid');
      var divisi = $(this).data('divisi');
      $('#nomor_complaint_prd').val(complaint);
      $('#custid_prd').val(custid_prd);
      $('#no_divisi_prd').val(divisi);

      $('#list_komitmen_prd_table').DataTable().destroy();
      load_komitmen_prd(complaint);

      var url = "{{ url('produksi_proses/show/no_complaint') }}";
      ...
      $.get(url, function (data) {
        ...
        if(data.data_hitung.div_lab == 0){
          $('#btn_request_lab_prd').show();
          $('#btn_no_request_lab_prd').hide();
        }else{
          $('#btn_request_lab_prd').hide();
          $('#btn_no_request_lab_prd').show();
        }
      })

      if(divisi == 1){
        $('#produksiform input[type="text"]'). prop("disabled", true);
        $('#produksiform input[type="file"]'). prop("disabled", true);
        $('#produksiform textarea'). prop("disabled", true);
        $('#btn_save_prd').hide();
        $('#btn_tidak_terlibat_prd').hide();
        $('#btn_terlibat_prd').show();
      }else{
        $('#produksiform input[type="text"]'). prop("disabled", false);
        $('#produksiform input[type="file"]'). prop("disabled", false);
        $('#produksiform textarea'). prop("disabled", false);
        $('#btn_save_prd').show();
        $('#btn_tidak_terlibat_prd').show();
        $('#btn_terlibat_prd').hide();
      }
    });

    $('#modal_proses_complaint_produksi').on('hidden.bs.modal', function () {
      for(var i = 1; i <= count; i++){
        $('#show_data_produksi_' + i).remove();
      }
    });

    $('body').on('click', '#save_input_komitmen_prd', function () {
      var selesai_tanggal_komitmen = $('#selesai_tanggal_komitmen_prd').val();
      var komitmen = $('#komitmen_prd').val();
      var nomor_complaint = $('#nomor_complaint_prd').val();

      $.ajax({
        type: "GET",
        url: "{{ url('save_data_komitmen_prd') }}",
        data: { 'selesai_tanggal_komitmen' : selesai_tanggal_komitmen, 'komitmen' : komitmen, 'nomor_complaint' : nomor_complaint },
        success: function (data) {
          $('#selesai_tanggal_komitmen_prd').val('');
          $('#komitmen_prd').val('');
          var oTable = $('#list_komitmen_prd_table').dataTable();
          oTable.fnDraw(false);
        },
        error: function (data) {  
          var oTable = $('#list_komitmen_prd_table').dataTable();
    ...
    $('body').on('click', '#btn_request_lab_prd', function () {
      var complaint = $('#nomor_complaint_prd').val();
      $('#nomor_complaint_req').val(complaint);
    });

    $('body').on('click', '#btn_no_request_lab_prd', function () {
      var complaint = $('#nomor_complaint_prd').val();
      if(confirm("Batalkan Request ke Lab?")){
        $.ajax({
          type: "GET",
          url: "{{ url('complaint_produksi/no_request_lab/') }}",
          data: { 'nomor_complaint' : complaint },
          success: function (data) {
    ...
    $('body').on('click', '#btn_tidak_terlibat_prd', function () {
      var complaint = $('#nomor_complaint_prd').val();
      $('#nomor_complaint_alasan').val(complaint);
    });

    $('body').on('click', '#btn_terlibat_prd', function () {
      var complaint = $('#nomor_complaint_prd').val();
      var custid = $('#custid_prd').val();
      var divisi = $('#no_divisi_prd').val();

      if(confirm("Apakah Anda Yakin?")){
        $.ajax({
          type: "GET",
          url: "{{ url('complaint_produksi/terlibat/') }}",
          ...
          success: function (data) {
            ...
            var oTablef = $('#complaint_produksi_diproses_table').dataTable();
            oTablef.fnDraw(false);
            $("#modal_proses_complaint_produksi").modal('hide');
            $("#modal_proses_complaint_produksi").trigger('click');
    ...
    $('body').on('click', '#edit_complaint_produksi', function () {
      var complaint = $(this).data('id');
      var custid_prd = $(this).data('custid');
      $('#edit_nomor_complaint_prd').val(complaint);
      $('#edit_custid_prd').val(custid_prd);
      var url = "{{ url('complaint_produksi/show/edit/no_complaint') }}";
      url = url.replace('no_complaint', enc(complaint.toString()));
      $('#edit_upload_file_prd').html('');
      $('#edit_evaluasi_prd').html('');
      $('#edit_solusi_customer_prd').html('');
      $('#edit_solusi_internal_prd').html('');
      $('#edit_komitmen_prd').html('');
      $('#edit_selesai_tanggal_komitmen_prd').html('');
      $.get(url, function (data) {
        $('#edit_evaluasi_prd').html(data.evaluasi);
        $('#edit_solusi_customer_prd').html(data.solusi_customer);
        $('#edit_solusi_internal_prd').html(data.solusi_internal);
        $('#edit_list_komitmen_prd_table').DataTable().destroy();
        load_edit_komitmen_prd(complaint);
        if(data.lampiran == null){
          $('#lihat_lampiran_prd').html('No Lampiran');
          $('#lihat_lampiran_prd').addClass('disabled');
          $('#lihat_lampiran_prd').attr('href', '#');
        }else{
          $('#lihat_lampiran_prd').html('Lihat Lampiran');
          $('#lihat_lampiran_prd').removeClass('disabled');
          $('#lihat_lampiran_prd').attr('href', '../data_file/' + data.lampiran);
        }
      })
    });

    $('body').on('click', '#save_new_edit_komitmen_prd', function () {
      var selesai_tanggal_komitmen = $('#edit_selesai_tanggal_komitmen_prd').val();
      var komitmen = $('#edit_komitmen_prd').val();
      var nomor_complaint = $('#edit_nomor_complaint_prd').val();

      $.ajax({
        type: "GET",
        url: "{{ url('save_new_edit_komitmen_prd') }}",
        data: { 'selesai_tanggal_komitmen' : selesai_tanggal_komitmen, 'komitmen' : komitmen, 'nomor_complaint' : nomor_complaint },
        success: function (data) {
          $('#edit_selesai_tanggal_komitmen_prd').val('');
          $('#edit_komitmen_prd').val('');
          var oTable = $('#edit_list_komitmen_prd_table').dataTable();
          oTable.fnDraw(false);
        },
        error: function (data) {  
          var oTable = $('#edit_list_komitmen_prd_table').dataTable();
    ...
    $('body').on('click', '#edit-komitmen', function () {
      ...
      $('#edit_komitmen_prd').val('');
      $('#edit_selesai_tanggal_komitmen_prd').val('');
      $('#edit_komitmen_lama_prd').val('');
      $('#edit_selesai_tanggal_komitmen_lama_prd').val('');
      $('#save_edit_komitmen_prd').show();
      $('#save_new_edit_komitmen_prd').hide();
      $.get(url, function (data) {
        $('#edit_selesai_tanggal_komitmen_prd').val(data.selesai_tanggal_komitmen);
        $('#edit_komitmen_prd').val(data.komitmen);
        $('#edit_selesai_tanggal_komitmen_lama_prd').val(data.selesai_tanggal_komitmen);
        $('#edit_komitmen_lama_prd').val(data.komitmen);
      })
    });

    $('body').on('click', '#save_edit_komitmen_prd', function () {
      var selesai_tanggal_komitmen = $('#edit_selesai_tanggal_komitmen_prd').val();
      var komitmen = $('#edit_komitmen_prd').val();
      var selesai_tanggal_komitmen_lama = $('#edit_selesai_tanggal_komitmen_lama_prd').val();
      var komitmen_lama = $('#edit_komitmen_lama_prd').val();
      var nomor_complaint = $('#edit_nomor_complaint_prd').val();
      $.ajax({
        type: "GET",
        url: "{{ url('update_edit_komitmen_prd') }}",
        ...
        success: function (data) {
          ...
          $('#edit_komitmen_lama_prd').val('');
          $('#edit_selesai_tanggal_komitmen_lama_prd').val('');
          $('#save_edit_komitmen_prd').hide();
          $('#save_new_edit_komitmen_prd').show();
          var oTable = $('#edit_list_komitmen_prd_table').dataTable();
          oTable.fnDraw(false);
        },
        error: function (data) {
    ...
    $('body').on('click', '#validate_complaint_produksi', function () {
      var nomor_complaint = $(this).data("id");
  ...
  $(document).ready(function () {
    $('#requestform').validate({
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          type:'POST',
          url: "{{ url('complaint_produksi/request_lab') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success: function (data) {
            ...
            $("#btn_request_lab_prd").hide();
            $("#btn_no_request_lab_prd").show();
            $('#modal_konfirmasi_request_lab').modal('hide');
            $("#modal_konfirmasi_request_lab").trigger('click');
    ...
    $('#alasantidakterlibatform').validate({
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          type:'POST',
          url: "{{ url('complaint_produksi/tidak_terlibat') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success: function (data) {
    ...
    $('#produksiform').validate({
      ...
      submitHandler: function(form) {
        var myform = document.getElementById("produksiform");
        var formdata = new FormData(myform);

        $.ajax({
          type:'POST',
          url:"{{ url('/complaint_produksi/store') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success:function(data){
            $('#produksiform').trigger("reset");
            var oTablea = $('#complaint_produksi_semua_table').dataTable();
            oTablea.fnDraw(false);
            var oTableb = $('#complaint_produksi_proses_table').dataTable();
            oTableb.fnDraw(false);
    ...
    $('#editproduksiform').validate({
      rules: {
        edit_nomor_complaint_prd: {
          required: true,
        },
        edit_custid_prd: {
          required: true,
        },
        edit_solusi_internal_prd: {
          required: true,
        },
        edit_upload_file_prd: {
          extension: "jpg,jpeg,pdf",
          filesize: 2,
        },
      },
      ...
      submitHandler: function(form) {
        var myform = document.getElementById("editproduksiform");
        var formdata = new FormData(myform);

        $.ajax({
          type:'POST',
          url:"{{ url('/complaint_produksi/edit') }}",
          data: formdata,
          processData: false,
          contentType: false,
          success:function(data){
            $('#editproduksiform').trigger("reset");
            var oTablea = $('#complaint_produksi_semua_table').dataTable();
            oTablea.fnDraw(false);
            var oTableb = $('#complaint_produksi_proses_table').dataTable();
            oTableb.fnDraw(false);
            ...
            var oTablee = $('#complaint_produksi_semua_admin_table').dataTable();
            oTablee.fnDraw(false);
            $("#modal_edit_complaint_produksi").modal('hide');
            $("#modal_edit_complaint_produksi").trigger('click');
            alert("Data Successfully Stored");
          },
          error: function (data) {
            console.log('Error:', data);
