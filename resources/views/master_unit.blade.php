...
@section('title')
<title>UNIT - PT. DWI SELO GIRI MAS</title>
@endsection
  ...
  <div class="row"> 
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <table id="data_unit_table" style="width: 100%;" class="table table-bordered table-hover responsive">
            <thead>
              <tr>
                <th>Kode</th>
                <th>Company</th>
        ...
        <div class="modal-body">
          <form method="post" class="edit_form" id="edit_form" action="javascript:void(0)" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  <label for="edit_kode">Kode Unit</label>
                  <input class="form-control" type="text" name="edit_kode" id="edit_kode" placeholder="Kode Unit" />
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  <label for="edit_nama">Nama Unit</label>
                  <input class="form-control" type="text" name="edit_nama" id="edit_nama" placeholder="Nama Unit" />
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = $('#data_unit_table').DataTable({
         processing: true,
         serverSide: true,
         lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
         ajax: {
          url:'{{ url("master_unit/table") }}',
    ...
    function load_data_unit()
    {
      table = $('#data_unit_table').DataTable({
         processing: true,
         serverSide: true,
         lengthMenu: [ [10, 25, 50, 100, -1], [10, 25, 50, 100, "All"] ],
         ajax: {
    ...
    $('body').on('click', '#view-data', function () {
      ...
      var url = "{{ url('master_unit/view/id') }}";
    ...
    $('body').on('click', '#edit-data', function () {
      ...
      $.get(url, function (data) {
        ...
        $('#edit_company').val(data.kode_perusahaan).trigger('change');
    ...
    $('body').on('click', '#delete-data', function () {
      ...
      if(confirm("Data Dihapus?")){
        $.ajax({
          type: "GET",
          url: "{{ url('master_unit/delete') }}",
          data: { 'kode' : kode },
          success: function (data) {
            var oTable = $('#data_unit_table').dataTable();
            oTable.fnDraw(false);
            alert("Data Deleted");
          },
          error: function (data) {
