...
class HasilLabPeriodicFirstExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithEvents, WithTitle
{
    ...
    public function view(): View
    {
        ...
        for($i = 0; $i < count($arr_mesin); $i++){
            ...
            foreach ($period as $date) {
                $arrayForTable[$arr_mesin[$i]][$date->format('Y-m-d')] = [];
            }
        }
        ...
        foreach($data_lab as $data_lab){
            ...
            $arrayForTable[$data_lab->mesin][$data_lab->tanggal_laporan_produksi][] = $temp;
        }

        // dd($arrayForTable);

        return view('excel_hasil_lab_periodic_first', [
            'data' => $arrayForTable
        ]);
    }
