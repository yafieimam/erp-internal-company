...
class HasilLabPeriodicSecondExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithEvents, WithTitle
{
    ...
    {
        $data_lab = DB::table('laporan_hasil_produksi as lap')->select('lap.tanggal_laporan_produksi', 'lab.jam_waktu', 'tbl_mesin.name as mesin', 'lab.mesh', 'lab.rpm', 'lab.std_ssa', 'lab.ssa', 'lab.std_d50', 'lab.d50', 'lab.std_d98', 'lab.d98', 'lab.cie86', 'lab.iso2470', 'lab.moisture', 'lab.residue', 'spek.residue_max', 'spek.whiteness_num as spek_whiteness', 'spek.moisture_num as spek_moisture', 'spek.residue_num as spek_residue')->join("laporan_hasil_produksi_lab as lab", "lap.nomor_laporan_produksi", "=", "lab.nomor_laporan_produksi")->join('tbl_mesin', 'tbl_mesin.id', '=', 'lab.mesin')->join('tbl_spesifikasi_mesin as spek', 'spek.mesin', '=', 'lab.mesin')->whereBetween('lap.tanggal_laporan_produksi', array($this->from_date, $this->to_date))->orderBy('lap.tanggal_laporan_produksi', 'asc')->orderBy('lab.mesin', 'asc')->orderBy('lab.jam_waktu', 'asc')->get();
        ...
        foreach ($period as $date) {
            $arrayForTable[$date->format('Y-m-d')] = [];
            for($i = 0; $i < count($arr_mesin); $i++){
                $arrayForTable[$date->format('Y-m-d')][$arr_mesin[$i]] = [];
            }
        }
        ...
        foreach($data_lab as $data_lab){
            ...
            $arrayForTable[$data_lab->tanggal_laporan_produksi][$data_lab->mesin][] = $temp;
        }

        // dd($arrayForTable);

        return view('excel_hasil_lab_periodic_second', [
            'data' => $arrayForTable
        ]);
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use ($styleArray)
            {
                ...
                // $event->sheet->getStyle('A3:N67')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                ...
                // $event->sheet->getStyle('A72:N136')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                //             'color' => ['argb' => '000000'],
                ...
                // $event->sheet->getStyle('A141:N205')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                //             'color' => ['argb' => '000000'],
                ...
                // $event->sheet->getStyle('A210:N274')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                //             'color' => ['argb' => '000000'],
                ...
                // $event->sheet->getStyle('A279:N343')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                //             'color' => ['argb' => '000000'],
                ...
                // $event->sheet->getStyle('A348:N412')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                //             'color' => ['argb' => '000000'],
                ...
                // $event->sheet->getStyle('A417:N481')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                //             'color' => ['argb' => '000000'],
                ...
                // $event->sheet->getStyle('A486:N550')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                //             'color' => ['argb' => '000000'],
                ...
                // $event->sheet->getStyle('A555:N619')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                //             'color' => ['argb' => '000000'],
                ...
                // $event->sheet->getStyle('A624:N688')->applyFromArray([
                //     'borders' => [
                //         'allBorders' => [
                //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                //             'color' => ['argb' => '000000'],
